---
aliases:
  - "Lenny Niemeyer · Pessoa · bianca almeida"
tags:
  - tipo/pessoa
...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`bianca almeida`**
### Nome preferido / como é chamado(a)
**bianca almeida**
### Email
**`bianca.almeida@lennyniemeyer.com`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
