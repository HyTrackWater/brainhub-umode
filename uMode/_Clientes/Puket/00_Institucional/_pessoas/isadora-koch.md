...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`isadora koch`**
### Nome preferido / como é chamado(a)
**isadora koch**
### Email
**`isadora.koch@grupounico.com`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
### Área (organizacional)
**Certificação** — **`Perfil de Acesso`** na tabela de usuários da plataforma.
