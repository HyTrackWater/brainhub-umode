...
`[a preencher]`
### Nome completo
**Sheilla** — da página do cliente. A base de demandas a escreve como `Sheilla`.
...
### Observação da fonte
⚠ **Só o primeiro nome, sem cargo e sem e-mail.** Aparece também no sub-toggle `Stakeholders`. 🔴 **A Hering é `Pré Onboarding`** — o time ainda não está formalizado na página.
