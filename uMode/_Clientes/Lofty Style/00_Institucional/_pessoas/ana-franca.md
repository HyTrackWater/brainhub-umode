...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Ana Paula França`**
### Nome preferido / como é chamado(a)
**Ana Paula França**
### Email
**`ana.franca@loftystyle.com.br`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
