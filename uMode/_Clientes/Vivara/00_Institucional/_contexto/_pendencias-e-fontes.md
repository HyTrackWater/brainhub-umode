...
>
> 🔴 **Este é o único lugar onde se pergunta "o que ainda não sei sobre o Vivara?" e
...
|--:|---|:-:|---|
| 1 | ⚠ **`Churn` com 1 módulo e ERP `SAP`.** | `T2` | — |
...
### 3.1 · Varridas para a carteira inteira — valem para o Vivara
...
**Cliente:** `Vivara` — [institucional.md](institucional.md) · [jornada.md](jornada.md) · [pessoas.md](pessoas.md)
