...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`aline castro`**
### Nome preferido / como é chamado(a)
**aline castro**
### Email
**`aline.castro@osklen.com.br`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
