...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Clarisse`**
### Nome preferido / como é chamado(a)
**Clarisse**
### Email
**`clarisse.navas@camys.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **26/07/2022** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Gerente de Estilo`. ⚠ **Sem sobrenome na coluna `Usuário`** — o e-mail sugere `Navas`, **não completei**.
