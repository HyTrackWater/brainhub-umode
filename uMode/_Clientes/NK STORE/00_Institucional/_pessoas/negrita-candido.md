...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Negrita Moreira Candido`**
### Nome preferido / como é chamado(a)
**Negrita Moreira Candido**
### Email
**`negrita.candido@nkstore.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
