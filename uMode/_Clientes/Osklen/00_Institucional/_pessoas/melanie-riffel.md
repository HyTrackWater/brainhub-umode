...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`MELANIE GIACOBBO RIFFEL`**
### Nome preferido / como é chamado(a)
**MELANIE GIACOBBO RIFFEL**
### Email
**`melanie.riffel@osklen.com.br`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
...
### Área (organizacional)
**Controladoria** — **`Área — auto-declarada na Pesquisa de Satisfação`** na tabela de usuários da plataforma.
