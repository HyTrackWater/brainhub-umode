---
aliases:
  - "Logística e Centro de Distribuição · Contexto de área — Ladeira Bijuterias"
tags:
  - tipo/area
...
- pessoas-da-area: ? — [não consta em: página Ladeira Bijuterias — 🔴 nenhuma fonte de pessoa por área encontrada · 2026-09-23]
- responsavel-area: ? — [não consta em: página Ladeira Bijuterias — 🔴 nenhuma fonte de pessoa por área encontrada · 2026-09-23]
...
1. Esta área existe neste cliente?
...
## Produto conectado
`[a preencher]` — **campo vazio na base** · ERP: `[a preencher]`
...
| Pessoas e responsáveis de área | Notion — página `Ladeira Bijuterias` — 🔴 **nenhuma fonte de pessoa por área encontrada** | varrido 23/09/2026 |
...
**Área:** `07_Logistica-CD` · **Cliente:** `Ladeira Bijuterias`
