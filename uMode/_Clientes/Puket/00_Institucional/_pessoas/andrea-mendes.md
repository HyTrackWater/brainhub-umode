...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`andrea mendes`**
### Nome preferido / como é chamado(a)
**andrea mendes**
### Email
**`andrea.mendes@grupounico.com`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **25/11/2022** |
