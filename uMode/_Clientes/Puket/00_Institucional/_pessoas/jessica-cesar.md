...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`jessica cesar`**
### Nome preferido / como é chamado(a)
**jessica cesar**
### Email
**`jessica.cesar@grupounico.com`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **22/06/2022** |
