---
aliases:
  - "Desenvolvimento de Coleção · Contexto de área — Highstil"
tags:
  - tipo/area
  - cliente/highstil
  - status/churn
...
- pessoas-da-area: ? — [não consta em: página Highstil — 🔴 nenhuma fonte de pessoa por área encontrada · 2026-09-23]
- responsavel-area: ? — [não consta em: página Highstil — 🔴 nenhuma fonte de pessoa por área encontrada · 2026-09-23]
...
## Produto conectado
`[a preencher]` — **campo vazio na base** · ERP: **`Totvs`**
...
| Pessoas e responsáveis de área | Notion — página `Highstil` — 🔴 **nenhuma fonte de pessoa por área encontrada** | varrido 23/09/2026 |
...
**Área:** `03_Desenvolvimento-de-Colecao` · **Cliente:** `Highstil`
