...
⚠ A área `03_Desenvolvimento-de-Colecao` **não aparece** entre os departamentos declarados, embora o módulo `Gestão de Coleção` esteja contratado. **A função pode estar aqui dentro** — **confirmar, não inferir**.
