...
>
> 🟢 **Esta área tem departamento, perfil e lista nominal** — a NK é a única conta varrida com base de usuários que declara **departamento, perfil e estado** por pessoa.
>
> Departamento na origem: **`Compras`** · perfil no PLM: **`NK - Compras`** · **6 pessoas**.
...
- pessoas-da-area: Marina Sacramento — [base Usuários em *Perfil de Usuário e Permissionamentos* · 2026-09-21]
...
## Pessoas desta área
**Marina Sacramento** — PMO do projeto e Compradora de Produtos Acabados · **Regiane Konopka** — Diretora de Merchandising, responde por **Compras, Industrial e Compliance** · **Isabely Consul Dantas**, **Heloisa Lima**, **Negrita Moreira Candido**, **Nelson Tadeu Alves Ferreira** (`expedicao2@`, caixa funcional) · **Cristina** (perfil `NK - Admin`, departamento Compras).

⚠ **kemelly.fernandes** tem **convite pendente desde 16/12/2024** — 21 meses.

## Uso do sistema nesta área
**Isabely Consul** abriu **6 chamados**, e os dois mais graves da conta são dela: **valores da ficha não chegam ao Linx** e **campos duplicados no cadastro** — ambos **`Em Aberto`**. **Cristina** abriu 2.

🔴 **O módulo `Fornecedores` está contratado, e a matriz mostra o perfil `Fornecedor` com 🔴 em praticamente tudo** — só vê Notificações, Editar Usuário, Sair e as duas Tarefas. **Não vê produto, lote, mapa de coleção nem custo.**

⚠ **E nem Admin nem Time podem criar novo fornecedor** (🔴 na matriz).

## Produto conectado
`Gestão de Coleção` · `Integração` · `Relatórios` · `Fornecedores` — 4 de 7. ERP **Linx**.
...
| Bloco | Fonte | Data |
|---|---|---|
| Pessoas, perfis, departamentos e estado | Notion — base `Usuários` em *Perfil de Usuário e Permissionamentos* | varrida 21/09/2026 |
...
*Demandas NK* · *NK | Criar Item da Rota/Beneficiamento* · *NK | Material Gerencial Diretoria* ·
bases `Reuniões com Cliente` e `Demandas` · *Documentação tech* · Plano de Sucesso do Cliente.
...
**Área:** `06_Compras-Supply-Sourcing` · **Cliente:** `NK STORE`
