...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`taissa`**
### Nome preferido / como é chamado(a)
**taissa**
### Email
**`taissa@osklen.com.br`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
