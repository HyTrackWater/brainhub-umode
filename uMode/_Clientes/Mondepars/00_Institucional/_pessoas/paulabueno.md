...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Paula Bueno`**
### Nome preferido / como é chamado(a)
**Paula Bueno**
### Email
**`paulabueno@mondepars.com`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **03/12/2025** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil `Dono`. 🔴 **Os 10 usuários desta conta têm perfil `Dono`** — a própria página declara: *Não há nenhum perfil definido por enquanto. Todos possuem status de donos da conta.* **Não há área derivável do perfil aqui.**
