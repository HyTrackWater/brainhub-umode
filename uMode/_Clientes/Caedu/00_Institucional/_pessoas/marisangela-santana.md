...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`marisangela santana`**
### Nome preferido / como é chamado(a)
**marisangela santana**
### Email
**`marisangela.santana@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **16/08/2023** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu-Qualidade`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `16/08/2023`.** Não deduzi a data. ⚠ **Sem acesso a:** `Aba de cadastros`, `Meus produtos`.
