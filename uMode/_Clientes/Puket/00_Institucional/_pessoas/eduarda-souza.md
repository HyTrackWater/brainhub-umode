...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Eduarda de Souza`**
### Nome preferido / como é chamado(a)
**Eduarda de Souza**
### Email
**`eduarda.souza@grupounico.com`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **21/06/2023** |
