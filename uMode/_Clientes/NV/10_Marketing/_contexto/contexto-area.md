...
>
> 🟢 **Esta área é declarada pelo próprio cliente.** O campo *"Departamentos engajados"* do template de transição, na página da NV, lista **`Marketing`**.
>
...
🟢 **A NV é o ÚNICO cliente do corpus com perfil de Marketing no PLM: `NV - Marketing`.**

⚠ **Na Oficina Reserva, Marketing divide perfil com E-commerce. Na Caedu e na Puket, a função é absorvida por Estilo.** 🔴 **Aqui ela tem acesso próprio.**
