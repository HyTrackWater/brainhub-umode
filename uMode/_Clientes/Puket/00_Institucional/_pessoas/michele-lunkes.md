...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`michele lunkes`**
### Nome preferido / como é chamado(a)
**michele lunkes**
### Email
**`michele.lunkes@grupounico.com`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **02/12/2022** |
