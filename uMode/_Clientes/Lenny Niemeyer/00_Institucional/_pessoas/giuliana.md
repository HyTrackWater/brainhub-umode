---
aliases:
  - "Lenny Niemeyer · Pessoa · Giuliana"
---
# Lenny Niemeyer · Pessoa · Giuliana
...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Giuliana`**
### Nome preferido / como é chamado(a)
**Giuliana**
### Email
**`giuliana.ghanem@lennyniemeyer.com`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
...
|---|---|
| **Demandas abertas** | **4** |
| Primeira atividade observada | 23/07/2025 |
| Última atividade observada | 23/07/2025 |
...
**Observação da fonte:** Giuliana Ghanem
