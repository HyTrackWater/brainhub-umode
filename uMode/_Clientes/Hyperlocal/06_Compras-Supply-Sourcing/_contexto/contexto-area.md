---
aliases:
  - "Compras, Supply e Sourcing · Contexto de área — Hyperlocal"
tags:
  - tipo/area
  - cliente/hyperlocal
  - status/churn
...
- pessoas-da-area: ? — [não consta em: página Hyperlocal — 🔴 nenhuma fonte de pessoa por área encontrada · 2026-09-23]
- responsavel-area: ? — [não consta em: página Hyperlocal — 🔴 nenhuma fonte de pessoa por área encontrada · 2026-09-23]
...
## Produto conectado
`[a preencher]` — **campo vazio na base** · ERP: **`Avec`**
...
| Pessoas e responsáveis de área | Notion — página `Hyperlocal` — 🔴 **nenhuma fonte de pessoa por área encontrada** | varrido 23/09/2026 |
...
**Área:** `06_Compras-Supply-Sourcing` · **Cliente:** `Hyperlocal`
