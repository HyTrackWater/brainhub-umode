...
🔴 **A conta separa compras em DOIS perfis:** `Objetiva - Compras` e **`Objetiva - Compras MP`** (matéria-prima).

⚠ **Nenhum outro cliente do corpus faz essa separação.** **Compra de produto e compra de insumo são acessos distintos aqui.**

⚠ **A aba `Integração` da ficha é 🟢 só para `Admin` e `Compras`** — os outros oito apenas visualizam.
...
**Área:** `06_Compras-Supply-Sourcing` · **Cliente:** `Moda Objetiva`
