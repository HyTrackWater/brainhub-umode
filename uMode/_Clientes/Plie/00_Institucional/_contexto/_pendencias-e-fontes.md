...
>
> 🔴 **Este é o único lugar onde se pergunta "o que ainda não sei sobre o Plie?" e
...
|--:|---|:-:|---|
| 1 | ⚠ **`Churn` com atendente nomeado em 2025.** Vinicius: mesmo grupo da Highstil, corte de gastos. | `T2` | nada — resolvido |
...
### 3.1 · Varridas para a carteira inteira — valem para o Plie
...
**Cliente:** `Plie` — [institucional.md](institucional.md) · [jornada.md](jornada.md) · [pessoas.md](pessoas.md)
