---
aliases:
  - "Compras, Supply e Sourcing · Contexto de área — Arezzo"
tags:
  - tipo/area
  - cliente/arezzo
...
- pessoas-da-area: ? — [não consta em: página Arezzo — 🔴 nenhuma fonte de pessoa por área encontrada · 2026-09-23]
- responsavel-area: ? — [não consta em: página Arezzo — 🔴 nenhuma fonte de pessoa por área encontrada · 2026-09-23]
...
## Produto conectado
`[a preencher]` — **campo vazio na base** · ERP: **`SAP e Linx`**
...
| Pessoas e responsáveis de área | Notion — página `Arezzo` — 🔴 **nenhuma fonte de pessoa por área encontrada** | varrido 23/09/2026 |
...
**Área:** `06_Compras-Supply-Sourcing` · **Cliente:** `Arezzo`
