...
- pessoas-da-area: Isabelle Dambiski — [Pesquisa Satisfação Kick Off e Treinamento · 2026-09-21]
...
## Pessoas desta área
**Isabelle Dambiski** (mar/2025) · **Mayra Obara** · **Amanda Lunardelli** · **Jovania Fernandes** · **Gabriela de Barros Cunha** (out/2025).

🔴 **Amanda Lunardelli é a pessoa mais ativa da conta: 6 dos 15 chamados são dela**, incluindo os dois primeiros de divergência de custo. **E ela deu CSat 10 e entusiasmo 5 em out/2025.** É usuária engajada esbarrando em defeito, não usuária insatisfeita.

⚠ **Jovania tem o menor índice da conta — entusiasmo 4, CSat 8** — e a ressalva dela era *"adicionar mais Campos categorizando e segmentando melhor. Por exemplo: Nome do tecido, Tipo: plano/malha"*. **Em 23/01/2026 ela abriu chamado `TAREFA/CONFIG`.**

⚠ **Isabelle deu CSat 7 em mar/2025** — o mais baixo da primeira pesquisa — com a ressalva *"a demora da implementação"*. **Não aparece na pesquisa de out/2025 nem em chamado.**

⚠ **Gabriela de Barros Cunha declarou `Sourcing / compras` em março e `Estilo` em outubro.** **Mudança de área — a única observável em toda a varredura.**
...
**Área:** `02_Estilo-Criacao` · **Cliente:** `Lofty Style`
