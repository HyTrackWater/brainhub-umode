...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Vitoria Fernanda`**
### Nome preferido / como é chamado(a)
**Vitoria Fernanda**
### Email
**`fernanda.coelho@nkstore.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
**Observação da fonte:** perfil de acesso `NK - Modelagem`. ⚠ **nome e e-mail divergem** (`Vitoria Fernanda` × `fernanda.coelho`) — não resolvi.
