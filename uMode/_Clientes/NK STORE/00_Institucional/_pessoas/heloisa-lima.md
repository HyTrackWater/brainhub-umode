...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`heloisa lima`**
### Nome preferido / como é chamado(a)
**heloisa lima**
### Email
**`heloisa.lima@nkstore.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
