...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`leticia martins`**
### Nome preferido / como é chamado(a)
**leticia martins**
### Email
**`leticia.martins@puket.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **14/06/2022** |
