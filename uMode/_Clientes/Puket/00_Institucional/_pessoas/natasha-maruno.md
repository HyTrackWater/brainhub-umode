...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`natasha maruno`**
### Nome preferido / como é chamado(a)
**natasha maruno**
### Email
**`natasha.maruno@grupounico.hk`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **30/06/2022** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** ⚠ **domínio `.hk`** — Hong Kong. Única da carteira fora do Brasil.
