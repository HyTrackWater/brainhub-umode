...
⚠ não estava no corpus antes de 03 ago 2026
...
|---|---|---|
| [Hering](../../_Clientes/Hering/00_Institucional/_contexto/institucional.md) | `Pré Onboardings` | `Ilimitar` |
| [Moda Objetiva](../../_Clientes/Moda Objetiva/00_Institucional/_contexto/institucional.md) | `Operação Assistida` | `Ilimitar` |
