...
>
> 🔴 **Este é o único lugar onde se pergunta "o que ainda não sei sobre o Hyperlocal?" e
...
### 3.1 · Varridas para a carteira inteira — valem para o Hyperlocal
...
**Cliente:** `Hyperlocal` — [institucional.md](institucional.md) · [jornada.md](jornada.md) · [pessoas.md](pessoas.md)
