---
aliases:
  - "NK STORE · Pessoa · cristina amorim"
tags:
  - tipo/pessoa
  - cliente/nk-store
  - status/ongoing
...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`cristina amorim`**
### Nome preferido / como é chamado(a)
**cristina amorim**
### Email
**`cristina.amorim@nkstore.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Status na base** | **CONVITE ACEITO em 08/01/2025** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `NK - Modelagem`. ⚠ **Segunda `Cristina` da base** — não fundi.
