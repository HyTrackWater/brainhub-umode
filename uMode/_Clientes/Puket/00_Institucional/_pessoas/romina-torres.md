...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`romina torres`**
### Nome preferido / como é chamado(a)
**romina torres**
### Email
**`romina.torres@puket.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **27/04/2023** |
