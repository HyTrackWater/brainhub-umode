...
>
> Departamentos que existem: `Estilo` · `PCP` · `Compras` · `Modelagem` · `TI`.
>
> Confirmados em reunião: Planejamento · Estilo · Merchandising · PCP · Tecnologia.
>
...
⚠ **Não há perfil de acesso nem departamento próprio.** O cadastro é descrito como tarefa do **Planejamento**:

> *"(Planejamento) realizar o **cadastro dos produtos no sistema**."*

⚠ **E o canal digital aparece sob Merchandising:**
> *"(Merchandising) também são responsáveis por garantir que os produtos estejam disponíveis nas **lojas físicas e no site** da empresa."*
...
## Pessoas desta área
**Nenhuma.** A área não tem departamento na base de usuários nem foi confirmada em reunião.
...
**Área:** `08_Ecommerce-Cadastro` · **Cliente:** `NK STORE`
