---
aliases:
  - "Desenvolvimento de Coleção · Contexto de área — Luiza Barcelos"
tags:
  - tipo/area
...
>
> **Time declarado:** Desenvolvimento
>
...
## Pessoas desta área
**Romulo Smaniotto** — Gerente de Desenvolvimento de Produto · `romulo.smaniotto@luizabarcelos.com.br`

**Ticiane Rosa** — Desenvolvimento · `ticiane.rosa@luizabarcelos.com.br` · 🟢 **`ATIVO` — a única pessoa da conta com evidência de uso**

**Sessão própria no kick-off presencial, 15h–16h**, com Gabriel, Gustavo e Romulo.
...
**Área:** `03_Desenvolvimento-de-Colecao` · **Cliente:** `Luiza Barcelos`
