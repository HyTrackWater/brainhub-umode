...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Helen Santos de Lima`**
### Nome preferido / como é chamado(a)
**Helen Santos de Lima**
### Email
**`helen.lima@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **09/01/2024** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu-Estilo`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `09/01/2024`.** Não deduzi a data. ⚠ **Sem acesso a:** `Aba de cadastros`, `Meus produtos`.
