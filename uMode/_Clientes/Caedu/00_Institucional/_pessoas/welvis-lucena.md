...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`welvis lucena`**
### Nome preferido / como é chamado(a)
**welvis lucena**
### Email
**`welvis.lucena@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **16/04/2024** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu-Produto`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `16/04/2024`.** Não deduzi a data. ⚠ **Sem acesso a:** `Aba de cadastros`, `Meus produtos`.
