...
`[a preencher]`
### Nome completo
**Marcelo** — da página do cliente. A base de demandas a escreve como `Marcelo`.
...
### Observação da fonte
⚠ **Aparece DUAS vezes no mesmo toggle** — em `Diretores e Representantes Legais` e em `Responsáveis pelos Projetos`, com o mesmo cargo `CEO`. **Uma ficha só.** 🔴 **Não há e-mail em nenhuma das duas ocorrências** — o rótulo existe e está vazio. O bloco traz telefone (`T0`, não copiado).
