...
`[a preencher]`
### Nome completo
**Day** — da página do cliente. A base de demandas a escreve como `Day`.
...
### Observação da fonte
⚠ **`Day` é como a fonte escreve** — primeiro nome ou apelido. ⚠ **Uma ata da mesma página cita `Dayana Carla Sestrem`**, mas **a fonte não liga os dois nomes**. **Não fundi** — `protocolo-varredura-cliente.md` § 9.
