...
### Quem são
🔴 **Setor declarado: `Software`** — **é o único cliente da carteira que não é de moda, vestuário, calçados ou joalheria.** **São Paulo.** CNPJ `18.285.421/0001-71`.
...
`[a preencher]` — 🔴 **`Hyperlocal` não consta na planilha de contratos do Financeiro.**
