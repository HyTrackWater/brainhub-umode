...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`andressa duarte`**
### Nome preferido / como é chamado(a)
**andressa duarte**
### Email
**`andressa.duarte@puket.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **21/06/2022** |
