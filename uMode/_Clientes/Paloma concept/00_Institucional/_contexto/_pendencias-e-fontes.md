...
>
> 🔴 **Este é o único lugar onde se pergunta "o que ainda não sei sobre o Paloma concept?" e
...
### 3.1 · Varridas para a carteira inteira — valem para o Paloma concept
...
**Cliente:** `Paloma concept` — [institucional.md](institucional.md) · [jornada.md](jornada.md) · [pessoas.md](pessoas.md)
