...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Vanessa`**
### Nome preferido / como é chamado(a)
**Vanessa**
### Email
**`vanessa.hanna@osklen.com.br`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
