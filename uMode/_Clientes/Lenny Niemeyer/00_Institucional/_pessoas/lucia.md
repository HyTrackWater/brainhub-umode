---
aliases:
  - "Lenny Niemeyer · Pessoa · Lúcia Rodrigues Garcia"
tags:
  - tipo/pessoa
...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Lúcia Rodrigues Garcia`**
### Nome preferido / como é chamado(a)
**Lúcia Rodrigues Garcia**
### Email
**`lucia@lennyniemeyer.com`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
