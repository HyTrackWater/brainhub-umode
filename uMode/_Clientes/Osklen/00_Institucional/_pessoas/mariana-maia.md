...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Mariana Maia`**
### Nome preferido / como é chamado(a)
**Mariana Maia**
### Email
**`mariana.maia@osklen.com.br`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
...
|---|---|
| **Demandas abertas** | **2** |
| Primeira atividade observada | 22/09/2025 |
| Última atividade observada | 22/09/2025 |
...
**Observação da fonte:** também Mari maia, Mari
