...
**Mariana**
### Email
**`mariana.bello@lennyniemeyer.com`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
...
### Área (organizacional)
**Coordenadora de desenvolvimento de produto** — **`Área — auto-declarada na Pesquisa de Satisfação`** na tabela de usuários da plataforma.
...
|---|---|
| **Demandas abertas** | **30** |
| Primeira atividade observada | 21/07/2025 |
| Última atividade observada | 04/02/2026 |
...
**Observação da fonte:** maior solicitante individual da carteira · também Mariana estilo
