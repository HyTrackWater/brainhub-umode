...
>
> 🟢 **Esta área é declarada pelo próprio cliente.** O campo *"Departamentos engajados"* do template de transição, na página da NV, lista **`Logística`**.
>
...
🟢 **A NV é o ÚNICO cliente do corpus com perfil de Logística no PLM: `NV - Logística`.**

⚠ **Em Caedu, Puket e Oficina Reserva, logística ou não aparece ou aparece só como destino do fluxo.** 🔴 **Aqui ela tem acesso próprio.**
...
**Área:** `07_Logistica-CD` · **Cliente:** `NV`
