...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`larissa ruani`**
### Nome preferido / como é chamado(a)
**larissa ruani**
### Email
**`larissa.ruani@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
**Observação da fonte:** perfil de acesso `Caedu-Produto`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `10/11/2023`.** Não deduzi a data. ⚠ **Sem acesso a:** `Aba de cadastros`, `Meus produtos`.
