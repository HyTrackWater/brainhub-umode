---
aliases:
  - "Osklen · Pessoa · priscilla retucci"
tags:
  - tipo/pessoa
  - cliente/osklen
...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`priscilla retucci`**
### Nome preferido / como é chamado(a)
**priscilla retucci**
### Email
**`priscilla.retucci@osklen.com.br`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
...
### Área (organizacional)
**Qualidade** — **`Área — auto-declarada na Pesquisa de Satisfação`** na tabela de usuários da plataforma.
