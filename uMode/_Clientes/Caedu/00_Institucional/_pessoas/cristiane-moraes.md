...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`cristiane moraes`**
### Nome preferido / como é chamado(a)
**cristiane moraes**
### Email
**`cristiane.moraes@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **09/10/2023** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu-Gerentes`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `09/10/2023`.** Não deduzi a data. ⚠ **Sem acesso a:** `Aba de cadastros`, `Meus produtos`.
