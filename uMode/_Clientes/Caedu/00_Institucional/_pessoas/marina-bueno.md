...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`marina bueno`**
### Nome preferido / como é chamado(a)
**marina bueno**
### Email
**`marina.bueno@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **03/01/0202** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu-Estilo`, da tabela de usuários da página do cliente. ⚠ **Sem acesso a:** `Aba de cadastros`, `Meus produtos`.
