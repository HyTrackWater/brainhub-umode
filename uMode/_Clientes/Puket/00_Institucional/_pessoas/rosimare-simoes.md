...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`rosimare simoes`**
### Nome preferido / como é chamado(a)
**rosimare simoes**
### Email
**`rosimare.simoes@puket.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
### Área (organizacional)
**TEX** — **`Perfil de Acesso`** na tabela de usuários da plataforma.
