...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`thamiris marangoni`**
### Nome preferido / como é chamado(a)
**thamiris marangoni**
### Email
**`thamiris.marangoni@lennyniemeyer.com`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
