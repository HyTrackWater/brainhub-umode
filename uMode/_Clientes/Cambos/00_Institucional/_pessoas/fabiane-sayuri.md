...
`[a preencher]`
### Nome completo
**Fabiane Sayuri** — da página do cliente. A base de demandas a escreve como `Fabiane Sayuri`.
...
### Área (organizacional)
**Desenvolvimento de Produtos** — ⚠ **como a fonte a nomeia**, não necessariamente uma das
