...
`[a preencher]`
### Nome completo
**Paulo Victor** — da página do cliente. A base de demandas a escreve como `Paulo Victor`.
### Nome preferido / como é chamado(a)
**Paulo Victor**
### Email
**`paulo.franca@luizabarcelos.com.br`** — e-mail **corporativo**, da página do cliente.
...
### Cadeira / cargo atual
**Assistente Administrativo, **migrando para Estratégia e Gestão****
