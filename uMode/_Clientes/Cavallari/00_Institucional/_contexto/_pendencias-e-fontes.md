...
>
> 🔴 **Este é o único lugar onde se pergunta "o que ainda não sei sobre o Cavallari?" e
...
### 3.1 · Varridas para a carteira inteira — valem para o Cavallari
...
**Cliente:** `Cavallari` — [institucional.md](institucional.md) · [jornada.md](jornada.md) · [pessoas.md](pessoas.md)
