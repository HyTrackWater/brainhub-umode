...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Marcelle`**
### Nome preferido / como é chamado(a)
**Marcelle**
### Email
**`marcelle.nobrega@osklen.com.br`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
...
### Área (organizacional)
**Projetos** — **`Área — auto-declarada na Pesquisa de Satisfação`** na tabela de usuários da plataforma.
...
|---|---|
| **Demandas abertas** | **3** |
| Primeira atividade observada | 05/01/2026 |
