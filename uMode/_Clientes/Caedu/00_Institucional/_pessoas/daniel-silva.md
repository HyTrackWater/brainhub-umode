...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Daniel Santana da Silva`**
### Nome preferido / como é chamado(a)
**Daniel Santana da Silva**
### Email
**`daniel.silva@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
**Observação da fonte:** perfil de acesso `Caedu- Planejamento`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `28/11/2023`.** Não deduzi a data. ⚠ **Sem acesso a:** `Meus produtos`.
