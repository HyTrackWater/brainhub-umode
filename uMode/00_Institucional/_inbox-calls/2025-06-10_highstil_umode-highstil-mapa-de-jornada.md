...
titulo: "uMode · Highstil - Mapa de Jornada"
data: 2025-06-10
...
---
# uMode · Highstil - Mapa de Jornada — 2025-06-10
...
| | |
|---|---|
| Reunião | **4 de 12** de Highstil nos acervos |
| Data | **2025-06-10** — **472 dias atrás** |
| Depois dela | **8 reuniões** — a última em **2026-02-20** |
...
- marco: Fases de Implementação e Priorização Vanessa Rinaldi explicou que os assuntos no mapa estão tagados com as fases de implementação (1, 2 e 3) definidas no kickoff. — [resumo Gemini 2025-06-10] ⚠ PROPOSTA · DERIVADA
