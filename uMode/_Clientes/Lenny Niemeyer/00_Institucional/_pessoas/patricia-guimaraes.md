---
aliases:
  - "Lenny Niemeyer · Pessoa · patricia guimaraes"
tags:
  - tipo/pessoa
...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`patricia guimaraes`**
### Nome preferido / como é chamado(a)
**patricia guimaraes**
### Email
**`patricia.guimaraes@lennyniemeyer.com`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
