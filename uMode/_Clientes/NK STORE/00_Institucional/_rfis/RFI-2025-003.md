---
aliases:
  - "NK STORE | RFI : Escopo - Alteração Integração (Parte 2) · RFI"
tags:
  - tipo/rfi
  - cliente/nk-store
  - status/ongoing
...
**Item 2 da RFI nao tem escopo claro**
...
> Narrativa vinda do export "RFIs Totais CSV e Markdown" (jul 2026, recuperado do histórico do Git — commit 8c6705b^) — arquivo `NK STORE RFI Escopo - Alteração Integração (Parte  271b1d38e76880fa9001cc33ee428442.md`, casado por
