...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Amanda`**
### Nome preferido / como é chamado(a)
**Amanda**
### Email
**`amanda.lunardelli@loftystyle.com.br`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
...
|---|---|
| **Demandas abertas** | **10** |
| Primeira atividade observada | 11/02/2026 |
| Última atividade observada | 17/04/2026 |
