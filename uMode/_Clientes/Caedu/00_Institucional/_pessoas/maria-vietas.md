...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Carolina Marchetti`**
### Nome preferido / como é chamado(a)
**Carolina Marchetti**
### Email
**`maria.vietas@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **13/11/0202** |
