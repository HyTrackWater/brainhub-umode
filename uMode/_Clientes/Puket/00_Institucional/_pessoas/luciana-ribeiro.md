...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`luciana ribeiro`**
### Nome preferido / como é chamado(a)
**luciana ribeiro**
### Email
**`luciana.ribeiro@puket.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **16/08/2022** |
