...
#### ✅ Aconteceu — 1 reuniões, de 2023-10-19 a 2023-10-19

| Data | Assunto (do título) | Natureza | Acervo | Fonte | Propostas no inbox |
|---|---|---|---|---|---|
| 2023-10-19 | discovery | não confirmada | Marina | ⚠ **só vídeo** — não lido | — |

#### 🔄 Acontecendo — o último estado conhecido

- **Última reunião nos acervos:** 2023-10-19 — *uMode · Vivara - Discovery uFlow (2023-10-19 14·33 GMT-3)* — **1072 dias atrás**.
- **Status no corpus:** `Churn` — varredura de 2026-09-22 (data da **leitura**, não da transição).
- 🟢 **Limite do churn:** o cliente estava em reunião em **2023-10-19**; a saída foi **depois** disso e **antes de 2026-09-22**. Data exata `[a preencher]`.

#### ⏭ Por vir

🔴 **Nada por vir registrado.** A última reunião tem 1072 dias; o que ela prometia é compromisso de 2023-10-19, **com cumprimento não verificado**.
...
| avaliações | **17** |
| nota média (1–5) | 🔴 **3.00** |
| avaliações com **flag** | **12** de 17 (71%) |
| período coberto | 05/03/2024 → 01/09/2024 |

**Percepção registrada:** **Precisamos de atenção e foco** (10) · **Cronograma atrasado  mas cliente satisfeito** (4) · **Bloqueio** (3).

**Quem avaliou (da uMode):** Andrea Holmer (14) · Marina (3).
