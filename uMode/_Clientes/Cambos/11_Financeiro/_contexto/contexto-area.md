...
>
> **Time declarado nas *Definições do Projeto*:** — (não listada em *Times Envolvidos*)
>
...
- produto-conectado: Gestão de Coleção · Integração · Relatórios — [planilha de contratos do Financeiro · 2026-09-21]
...
⚠ **A área não está entre os *Times Envolvidos* do projeto**, mas tem responsável nomeado na seção *Pessoas*. **Está na conta, não no projeto.**

🔴 **O Valter tem um e-mail em cada domínio** — `@cambos.com.br` (marca) e `@souzacambos.com.br` (fábrica/razão social). **É a prova de que domínio é pista, não chave**, e de que `alternateEmails` é campo necessário.

⚠ **O e-mail financeiro está na página e o campo `Email Principal Financeiro` da base está VAZIO.** **O dado existe e não chegou ao campo.**
...
## Pessoas desta área
**Valter** — **Head Financeiro** · `valter@cambos.com.br` **e** `fiscal@souzacambos.com.br`
...
**Área:** `11_Financeiro` · **Cliente:** `Cambos`
