...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`thais diniz`**
### Nome preferido / como é chamado(a)
**thais diniz**
### Email
**`thais.diniz@osklen.com.br`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
