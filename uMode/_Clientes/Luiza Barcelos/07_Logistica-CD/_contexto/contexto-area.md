...
>
> **Time declarado:** Operações (parcial)
>
...
## Pessoas desta área
**Marcelo Tonello** — Gerente de Operação do Sul · `marcelo.tonello@luizabarcelos.com.br`

**Fonte:** o próprio registro do cargo diz **"Logística e Cadastro"**.
...
**Área:** `07_Logistica-CD` · **Cliente:** `Luiza Barcelos`
