...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Andrea Nunes`**
### Nome preferido / como é chamado(a)
**Andrea Nunes**
### Email
**`andrea.nunes@grupounico.com`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
|---|---|
| **Demandas abertas** | **1** |
| Primeira atividade observada | 16/04/2026 |
| Última atividade observada | 16/04/2026 |
| Fonte | campo `Quem solicitou?` da base de demandas do Notion |
| **Ativo na plataforma desde** | **23/06/2022** |
