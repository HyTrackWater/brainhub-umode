---
aliases:
  - "Estilo e Criação · Contexto de área — VIX"
tags:
  - tipo/area
  - cliente/vix
  - status/ongoing
...
>
> **Perfis desta área:** `Vix-Estilo Biquini` · `Vix-Estilo Cover ups` · `Vix-Estilo Roupas` · `Vix-Estilo PA` · `Vix- Estilo Admim`
>
...
**Área:** `02_Estilo-Criacao` · **Cliente:** `VIX`
