...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Bianca Rocha da Silva`**
### Nome preferido / como é chamado(a)
**Bianca Rocha da Silva**
### Email
**`bianca.silva@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
**Observação da fonte:** perfil de acesso `Caedu-Estilo`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `10/01/2024`.** Não deduzi a data. ⚠ **Sem acesso a:** `Aba de cadastros`.
