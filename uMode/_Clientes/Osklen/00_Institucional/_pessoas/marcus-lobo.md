...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`marcus lobo`**
### Nome preferido / como é chamado(a)
**marcus lobo**
### Email
**`marcus.lobo@osklen.com.br`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
