---
aliases:
  - "E-commerce e Cadastro · Contexto de área — Susie Modas"
tags:
  - tipo/area
  - cliente/susie-modas
  - status/inativo
...
- pessoas-da-area: ? — [não consta em: página Susie Modas — 🔴 nenhuma fonte de pessoa por área encontrada · 2026-09-23]
- responsavel-area: ? — [não consta em: página Susie Modas — 🔴 nenhuma fonte de pessoa por área encontrada · 2026-09-23]
...
| Pessoas e responsáveis de área | Notion — página `Susie Modas` — 🔴 **nenhuma fonte de pessoa por área encontrada** | varrido 23/09/2026 |
...
**Área:** `08_Ecommerce-Cadastro` · **Cliente:** `Susie Modas`
