...
- id: mondpars — [varredura do Notion · 2026-09-22]
- segmento: ? — [sem fonte]
...
### Aliases do cliente
**`Mondepars`** — 🟢 **grafia confirmada pelo Vinícius em 22 set 2026** (*o nome certo da empresa é Mondepars*). ⚠ **Alias a reconhecer:** `Mondepars`, a grafia errada que o CRM ainda usa.
...
### Usuários da conta
**10 pessoas com ficha própria** no corpus.
...
### ⚠ Divergência de grafia entre corpus e base
🟢 **Resolvido em 22 set 2026 pelo Vinícius: o nome certo é `Mondepars`.** A pasta foi renomeada. ⚠ **A correção no CRM segue pendente** — quem ler lá ainda vai achar `Mondepars`.

> **Preservei as duas e não escolhi.** **Corrigir é na fonte.** Registrado aqui para a próxima reconciliação não contar dois clientes.
...
**Registros:** **10 fichas de pessoa** — [índice](../_pessoas/_indice.md)
