...
## O que esta área faz
Implantação, ongoing e gestão de contas. É onde o cliente vive pós-fechamento.

## Com quem se relaciona (interno e externo)
[a detalhar com o responsável da área]

## Entregas e responsabilidades
60% demandas via agente · RFI R$ 100k · 3 indicações/ano · NPS 100%

## Padrões operacionais
### Como trabalhamos
Toda demanda mapeada no CX-Hub antes de qualquer alteração em produção.
