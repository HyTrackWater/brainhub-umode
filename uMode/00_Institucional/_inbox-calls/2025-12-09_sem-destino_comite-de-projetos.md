...
tem_resumo: true
posicao_na_linha_do_tempo: 98/127
reunioes_depois: 29
idade_em_dias: 290
horizonte: historico
tier: T2
...
| | |
|---|---|
| Reunião | **98 de 127** de destino não identificado nos acervos |
| Data | **2025-12-09** — **290 dias atrás** |
| Depois dela | **29 reuniões** — a última em **2026-09-22** |
| Status no corpus | `[a preencher]` — cliente sem pasta ou sem fato `status` |

⚠ **Esta reunião é história.** O que ela afirma **aconteceu em 2025-12-09**; o que prometia
