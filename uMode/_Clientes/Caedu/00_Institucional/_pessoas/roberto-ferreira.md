...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`roberto ferreira`**
### Nome preferido / como é chamado(a)
**roberto ferreira**
### Email
**`roberto.ferreira@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
### Área (organizacional)
**E-commerce** — **`Perfil de Acesso`** na tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **02/08/2023** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu-E-commerce`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `02/08/2023`.** Não deduzi a data. ⚠ **Sem acesso a:** `Aba de cadastros`, `Meus produtos`.
