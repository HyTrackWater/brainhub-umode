...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`bruno vasconcellos`**
### Nome preferido / como é chamado(a)
**bruno vasconcellos**
### Email
**`bruno.vasconcellos@osklen.com.br`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
...
### Área (organizacional)
**Projetos & Real Estate** — **`Área — auto-declarada na Pesquisa de Satisfação`** na tabela de usuários da plataforma.
