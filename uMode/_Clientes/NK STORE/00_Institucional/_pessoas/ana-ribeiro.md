...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`ana ribeiro`**
### Nome preferido / como é chamado(a)
**ana ribeiro**
### Email
**`ana.ribeiro@nkstore.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Status na base** | **CONVITE ACEITO em 27/02/2025** |
