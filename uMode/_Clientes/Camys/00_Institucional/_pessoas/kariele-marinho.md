...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Kariele`**
### Nome preferido / como é chamado(a)
**Kariele**
### Email
**`kariele.marinho@camys.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **03/11/2023** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Gerente de Estilo`. ⚠ **Sem sobrenome na coluna `Usuário`** — o e-mail sugere `Marinho`, **não completei**.
