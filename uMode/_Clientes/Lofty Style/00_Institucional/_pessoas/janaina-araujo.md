...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Janaína`**
### Nome preferido / como é chamado(a)
**Janaína**
### Email
**`janaina.araujo@loftystyle.com.br`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
