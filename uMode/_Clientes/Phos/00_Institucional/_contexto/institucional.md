...
- id: phos — [varredura do Notion · 2026-09-22]
...
`[a preencher]` — 🔴 **`Phos` não consta na planilha de contratos do Financeiro.**
...
## Contexto crítico
### Onde estamos
🔴 **Churn mais rápido da carteira.**

Linha criada em **30/01/2026** e marcada `Churn` até **abril de 2026** — **menos de três meses.**

> **Não afirmo que o cliente durou três meses** — afirmo que **a linha foi criada e encerrada nesse intervalo**. **Pode nunca ter sido cliente de fato.** `[a preencher]`
