...
`[a preencher]`
### Nome completo
**Luiz Raul Aleixo Barcelos** — da página do cliente. A base de demandas a escreve como `Luiz Raul Aleixo Barcelos`.
### Nome preferido / como é chamado(a)
**Luiz Raul Aleixo Barcelos**
### Email
**`luiz@luizabarcelos.com.br`** — e-mail **corporativo**, da página do cliente.
...
### Observação da fonte
🟢 **Trazido pelo Vinícius em 22 set 2026**, copiando à mão um bloco que este conector não renderiza. ⚠ **É o único Diretor/Representante Legal nomeado da conta**, e o e-mail dele é o mesmo do campo `Email Principal Financeiro` da base. 🔴 **A fonte traz telefone e CPF — nenhum dos dois entrou aqui.**
