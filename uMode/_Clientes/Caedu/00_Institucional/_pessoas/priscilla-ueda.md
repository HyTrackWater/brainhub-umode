...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Priscilla`**
### Nome preferido / como é chamado(a)
**Priscilla**
### Email
**`priscilla.ueda@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
### Área (organizacional)
**Planejamento** — **`Perfil de Acesso`** na tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **24/01/2024** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu- Planejamento`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `24/01/2024`.** Não deduzi a data. ⚠ **Sem acesso a:** `Meus produtos`.
