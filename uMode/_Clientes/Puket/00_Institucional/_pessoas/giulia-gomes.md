...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`giulia gomes`**
### Nome preferido / como é chamado(a)
**giulia gomes**
### Email
**`giulia.gomes@puket.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **13/06/2022** |
