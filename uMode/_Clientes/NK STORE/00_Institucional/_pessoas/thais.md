...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Thais`**
### Nome preferido / como é chamado(a)
**Thais**
### Email
**`thais.cerqueira@nkstore.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
|---|---|
| **Demandas abertas** | **1** |
| Primeira atividade observada | 06/03/2025 |
| Última atividade observada | 06/03/2025 |
| Fonte | campo `Quem solicitou?` da base de demandas do Notion |
| **Status na base** | **CONVITE ACEITO em 12/02/2025** |
