...
tem_resumo: true
posicao_na_linha_do_tempo: 4/15
reunioes_depois: 11
idade_em_dias: 464
horizonte: historico
tier: T2
...
| | |
|---|---|
| Reunião | **4 de 15** de Cambos nos acervos |
| Data | **2025-06-18** — **464 dias atrás** |
| Depois dela | **11 reuniões** — a última em **2026-09-23** |
...
- dor: Compartilhamento de Tela e Campos Existentes Laura Delgado teve dificuldades em visualizar a aba de aprovação compartilhada por Louise Carlos, recomendando o compartilhamento da tela inteira. — [resumo Gemini 2025-06-18] ⚠ PROPOSTA · DERIVADA
