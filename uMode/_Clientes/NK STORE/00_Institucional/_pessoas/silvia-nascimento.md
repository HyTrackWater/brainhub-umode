...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Silvia`**
### Nome preferido / como é chamado(a)
**Silvia**
### Email
**`silvia.nascimento@nkstore.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
### Área (organizacional)
**Modelagem** — **`Departamento NK`** na tabela de usuários da plataforma.
...
| **Status na base** | **CONVITE ACEITO em 15/01/2025** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `NK - Modelagem`. ⚠ **Há uma ficha `silvia-shirlei-dias.md`** vinda da base de demandas. **NÃO fundi:** `Shirlei Dias` × `nascimento` não batem.
