...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`vinicius cesar`**
### Nome preferido / como é chamado(a)
**vinicius cesar**
### Email
**`vinicius.cesar@grupounico.com`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
### Área (organizacional)
**BI** — **`Perfil de Acesso`** na tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **04/10/2022** |
