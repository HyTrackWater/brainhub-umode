...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Renata`**
### Nome preferido / como é chamado(a)
**Renata**
### Email
**`renata.abinader@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **15/12/2023** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu-Estilo`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `15/12/2023`.** Não deduzi a data. ⚠ **Sem acesso a:** `Aba de cadastros`.
