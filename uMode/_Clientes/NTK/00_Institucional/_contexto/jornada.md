...
#### ✅ Aconteceu — 2 reuniões, de 2023-05-30 a 2023-07-10

| Data | Assunto (do título) | Natureza | Acervo | Fonte | Propostas no inbox |
|---|---|---|---|---|---|
| 2023-05-30 | — | não confirmada | Laura | só chat | — |
| 2023-07-10 | — | não confirmada | Juliana | só chat | — |

#### 🔄 Acontecendo — o último estado conhecido

- **Última reunião nos acervos:** 2023-07-10 — *Impressão NTK (2023-07-10 11·03 GMT-3)* — **1173 dias atrás**.
- **Status no corpus:** `Churn` — varredura de 2026-09-22 (data da **leitura**, não da transição).
- 🟢 **Limite do churn:** o cliente estava em reunião em **2023-07-10**; a saída foi **depois** disso e **antes de 2026-09-22**. Data exata `[a preencher]`.

#### ⏭ Por vir

🔴 **Nada por vir registrado.** A última reunião tem 1173 dias; o que ela prometia é compromisso de 2023-07-10, **com cumprimento não verificado**.
...
| avaliações | **18** |
| nota média (1–5) | 🔴 **2.89** |
| avaliações com **flag** | **9** de 18 (50%) |
| período coberto | 15/02/2024 → 08/11/2024 |

**Percepção registrada:** **Bloqueio** (8) · **Precisamos de atenção e foco** (6) · **Cronograma atrasado e cliente insatisfeito** (2) · **Cronograma atrasado  mas cliente satisfeito** (2).

**Quem avaliou (da uMode):** Elizabeth (15) · Dalker (1) · Rafael (1) · Elizabeth Alves (1).
