...
- id: vivara — [varredura do Notion · 2026-09-22]
- segmento: Joalheria — [varredura do Notion · 2026-09-22]
...
- erp: SAP — [varredura do Notion · 2026-09-22]
...
### Quem são
**Joalheria**, em **São Paulo**. 🔴 **É a maior marca de joalheria do Brasil** — `[a preencher]`, não confirmado em fonte varrida, mas **o porte importa para entender o churn**.
...
- Marina Santoro — 33 reuniões da conta
- Luciano Troiani — 3 reuniões da conta
- Andrea Holmer — 3 reuniões da conta
...
`[a preencher]` — 🔴 **`Vivara` não consta na planilha de contratos do Financeiro.**
