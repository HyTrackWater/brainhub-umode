...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Izabella`**
### Nome preferido / como é chamado(a)
**Izabella**
### Email
**`izabella.veloso@loftystyle.com.br`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
