...
⚠ **ferramenta DO CLIENTE, não da uMode.** A Cambos usa para gestão do processo. 🔴 **Não estava no enum `tool` do corpus** — achada ao abrir a página do cliente em 22 set 2026
