...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`luis stepan`**
### Nome preferido / como é chamado(a)
**luis stepan**
### Email
**`luis.stepan@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **05/05/2023** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Gerente de Estilo / Caedu-Estilo`, da tabela de usuários da página do cliente. 🔴 **O campo traz cargo E perfil na mesma célula** (`Gerente de Estilo / Caedu-Estilo`) — a fonte mistura as duas coisas. 🔴 **`Ativo desde` está corrompido na fonte: `05/05/2023`.** Não deduzi a data. ⚠ **Sem acesso a:** `Aba de cadastros`.
