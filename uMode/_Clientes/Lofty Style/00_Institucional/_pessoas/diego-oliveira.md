...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Diego`**
### Nome preferido / como é chamado(a)
**Diego**
### Email
**`diego.oliveira@loftystyle.com.br`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
