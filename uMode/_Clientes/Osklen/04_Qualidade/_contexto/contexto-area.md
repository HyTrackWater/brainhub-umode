...
- pessoas-da-area: 4 pessoas, em três rótulos diferentes — [Pesquisa Satisfação Kick Off Osklen · 2025-03-25]
...
## Pessoas desta área
**4 pessoas**, em **três rótulos diferentes**.

**Ana Dias** e **Priscilla Retucci** (`Qualidade`) · **Karina Caroline Reiter Peres** (`Qualidade (GDF)`) · **Michelle** (`Qualidade e Acabamento`).
...
**Área:** `04_Qualidade` · **Cliente:** `Osklen`
