...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Catarina`**
### Nome preferido / como é chamado(a)
**Catarina**
### Email
**`catarina.bassotto@grupounico.com`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
|---|---|
| **Demandas abertas** | **5** |
| Primeira atividade observada | 17/07/2025 |
| Última atividade observada | 13/01/2026 |
