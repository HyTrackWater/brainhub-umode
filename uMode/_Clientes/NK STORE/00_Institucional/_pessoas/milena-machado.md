...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`milena machado`**
### Nome preferido / como é chamado(a)
**milena machado**
### Email
**`milena.machado@nkstore.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Status na base** | **CONVITE ACEITO em 27/01/2025** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `NK - PCP`.
