...
| 3 | **Não há fonte de desligamento.** | Nenhum sistema varrido registra saída de pessoa. O único sinal é **tachado na origem** (1 caso no Puket) `[C]`. `DESATIVADO` vai ser raro e subnotificado. |
