...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`edson floriani`**
### Nome preferido / como é chamado(a)
**edson floriani**
### Email
**`edson.floriani@osklen.com.br`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
...
### Área (organizacional)
**Fábrica** — **`Área — auto-declarada na Pesquisa de Satisfação`** na tabela de usuários da plataforma.
