...
## Identificação
### Nome na fonte
**`SPI - Sistema próprio da Cambos`**
### Natureza
**Sistema de terceiro** — ERP/integração do cliente. 🔴 **Não é produto da uMode.**
### Fornecedor
Cambos (o próprio cliente)
### Observação de taxonomia
🔴 **não é produto de mercado** — é sistema interno do cliente
...
|---|---|---|
| [Cambos](../../_Clientes/Cambos/00_Institucional/_contexto/institucional.md) | `Ongoing` | `SPI - Sistema próprio da Cambos` |
