...
`[a preencher]`
### Nome completo
**Gabriel Jaques da Silva** — da página do cliente. A base de demandas a escreve como `Gabriel Jaques da Silva`.
### Nome preferido / como é chamado(a)
**Gabriel Jaques da Silva**
### Email
**`gabriel.silva@luizabarcelos.com.br`** — e-mail **corporativo**, da página do cliente.
...
### Cadeira / cargo atual
**Coordenador de Merchandising — **Líder Central do Projeto****

Fonte: página do cliente no Notion, toggle `Pessoas` › `Responsáveis pelo Projeto`.
### Nível HIC
⚠ **não se aplica** — é campo da Casa uMode
### Área (organizacional)
**Merchandising** — ⚠ **como a fonte a nomeia**, não necessariamente uma das
...
### Observação da fonte
🟢 **RESOLVIDO em 22 set 2026:** a ata da reunião de 07/06/2024 escreve o nome completo — **`Gabriel Jaques da Silva`**. `Jaques` é nome do meio, `Silva` é o sobrenome do e-mail. **Não eram duas pessoas nem erro: era nome truncado.**
