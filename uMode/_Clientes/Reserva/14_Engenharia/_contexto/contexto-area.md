...
## Pessoas desta área
**Raquel** — citada como **Eng** no grupo *"uMode - Importante"*. Estado `INDETERMINADO`.

> ⚠ A mesma **Raquel** aparece ligada a **Cadastro** em outro grupo. **Não resolvi a ambiguidade** — ver `08_Ecommerce-Cadastro`.

## Canais de comunicação desta área
- *"uMode - Importante"* 🟢 **manter**
- *"Comitê uMode <> Reserva"* 🔴 **excluir**

## Dores e frentes abertas
- **Carta lacre com somente itens aprovados** — card aberto no board 18 do Kanbanize.
...
**Área:** `14_Engenharia` · **Cliente:** `Reserva`
