...
**juliana**
### Email
**`juliana@osklen.com.br`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
...
### Área (organizacional)
**Design de moda** — **`Área — auto-declarada na Pesquisa de Satisfação`** na tabela de usuários da plataforma.
