...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Nabilla`**
### Nome preferido / como é chamado(a)
**Nabilla**
### Email
**`nabilla.mello@lennyniemeyer.com`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
...
### Área (organizacional)
**Assistente de estilo** — **`Área — auto-declarada na Pesquisa de Satisfação`** na tabela de usuários da plataforma.
