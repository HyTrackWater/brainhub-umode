...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Elad`**
### Nome preferido / como é chamado(a)
**Elad**
### Email
**`elad.lander@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
**Observação da fonte:** perfil de acesso `Caedu-Gerentes`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `28/11/2023`.** Não deduzi a data. ⚠ **Sem acesso a:** `Aba de cadastros`, `Mapa de Produtos`.
