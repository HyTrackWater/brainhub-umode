---
aliases:
  - "Compras, Supply e Sourcing · Contexto de área — Puket"
tags:
  - tipo/area
  - cliente/puket
  - status/ongoing
...
- pessoas-da-area: 9 pessoa(s) com acesso ao PLM nesta área: — [página Puket, tabela do PLM · 2026-09-21]
- responsavel-area: ? — [não consta em: página Puket, tabela do PLM · 2026-09-21]

## O que esta área faz

**Responde pela cotação e aprovação de custos**, última das oito etapas de desenvolvimento:

> *"8. **Cotação e Aprovação de Custos**."* — `Mapeamento de Conta Puket — segundo Notion`, 21/03/2025

⚠ **Duas das seis aprovações formais são de insumo:** *aprovação de tecidos sólidos* e *aprovação de aviamentos* (mesma fonte).
...
## Pessoas desta área
**9 pessoa(s)** com acesso ao PLM nesta área:

- `Sourcing Nacional` — 7 pessoa(s)
- `Importação` — 2 pessoa(s)

**Distribuição por domínio:** grupounico.com: 8 · puket.com.br: 1
...
**Área:** `06_Compras-Supply-Sourcing` · **Cliente:** `Puket`
