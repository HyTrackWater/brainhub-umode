...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`julia leone`**
### Nome preferido / como é chamado(a)
**julia leone**
### Email
**`julia.leone@nkstore.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Status na base** | **CONVITE ACEITO em 18/12/2024** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `NK - Estilo`. ⚠ **Segunda `Julia` da base** (com `Júlia Fontoura`) — não fundi.
