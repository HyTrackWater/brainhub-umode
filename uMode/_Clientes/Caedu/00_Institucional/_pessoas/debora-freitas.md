...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`debora freitas`**
### Nome preferido / como é chamado(a)
**debora freitas**
### Email
**`debora.freitas@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **18/07/2023** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu-Produto`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `18/07/2023`.** Não deduzi a data. ⚠ **Sem acesso a:** `Aba de cadastros`.
