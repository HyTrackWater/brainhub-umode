...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`leticia santos`**
### Nome preferido / como é chamado(a)
**leticia santos**
### Email
**`leticia.santos@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
**Observação da fonte:** perfil de acesso `Caedu-Estilo`, da tabela de usuários da página do cliente. ⚠ **Sem acesso a:** `Aba de cadastros`.
