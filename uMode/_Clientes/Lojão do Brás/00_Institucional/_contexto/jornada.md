...
| avaliações | **13** |
| nota média (1–5) | ⚠ **3.62** |
| avaliações com **flag** | **2** de 13 (15%) |
| período coberto | 10/05/2024 → 08/11/2024 |

**Percepção registrada:** **Tudo em dia** (12) · **Precisamos de atenção e foco** (1).

**Quem avaliou (da uMode):** Laura (13).
