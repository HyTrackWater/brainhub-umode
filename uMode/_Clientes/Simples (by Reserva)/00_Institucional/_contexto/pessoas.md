...
**Nenhuma fonte varrida nomeia pessoa deste cliente** — e **não há linha na base para ter campo de atendimento.**
...
|---|---|---|---|---|
| **Portal uMode | Simples Reserva** | Notion | `[a preencher]` | — | criado em **18/10/2024** · **não varrido** |
