...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`sarah nunes`**
### Nome preferido / como é chamado(a)
**sarah nunes**
### Email
**`sarah.nunes@grupounico.com`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
### Área (organizacional)
**Controladoria** — **`Perfil de Acesso`** na tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **16/06/2023** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** 🔴 **O perfil está RISCADO na fonte** — marca de desativação. ⚠ **Não afirmo que saiu:** afirmo que a fonte riscou.
