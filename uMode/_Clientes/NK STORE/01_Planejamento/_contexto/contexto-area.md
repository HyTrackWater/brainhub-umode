...
> Criado em **21 set 2026**. 🔴 **`Planejamento` foi confirmado como departamento envolvido na reunião de warm-up de 19/06, tem coordenadora nomeada — e não existe na base de usuários do PLM.**
>
> **Acordado em reunião, nunca implantado em acesso.**
...
## Pessoas desta área
**Bruna** — Coordenadora do Planejamento, nomeada na página do cliente.

🔴 **Mas `Planejamento` NÃO é um departamento na base de usuários**, e **a Bruna não aparece lá**. O departamento foi **confirmado em reunião** (warm-up de 19/06) e **nunca virou acesso**.

> **É a divergência mais séria entre o acordado e o implantado nesta conta.**

## O que levar ao negócio
1. A área existe na NK STORE?
2. Se existe, **por que não tem ninguém no PLM nem foi confirmada no kick-off**?
3. Deveria entrar numa onda seguinte?
...
**Área:** `01_Planejamento` · **Cliente:** `NK STORE`
