# Luiza Barcelos · Pessoa · Marcelo Tonello
...
`[a preencher]`
### Nome completo
**Marcelo Tonello** — da página do cliente. A base de demandas a escreve como `Marcelo Tonello`.
### Nome preferido / como é chamado(a)
**Marcelo Tonello**
### Email
**`marcelo.tonello@luizabarcelos.com.br`** — e-mail **corporativo**, da página do cliente.
...
### Cadeira / cargo atual
**Gerente de Operação do Sul — logística e cadastro, do desenvolvimento até a precificação**

Fonte: página do cliente no Notion, toggle `Pessoas` › `Participantes do Projeto`.
### Nível HIC
⚠ **não se aplica** — é campo da Casa uMode
### Área (organizacional)
**Operações** — ⚠ **como a fonte a nomeia**, não necessariamente uma das
