---
aliases:
  - "Compras, Supply e Sourcing · Contexto de área — Studio Minah"
tags:
  - tipo/area
...
- pessoas-da-area: ? — [não consta em: página Studio Minah — 🔴 nenhuma fonte de pessoa por área encontrada · 2026-09-23]
- responsavel-area: ? — [não consta em: página Studio Minah — 🔴 nenhuma fonte de pessoa por área encontrada · 2026-09-23]
...
## Produto conectado
`Gestão de Coleção` — **1 de 7** · ERP: **`Sem Integração`**
...
| Pessoas e responsáveis de área | Notion — página `Studio Minah` — 🔴 **nenhuma fonte de pessoa por área encontrada** | varrido 23/09/2026 |
...
**Área:** `06_Compras-Supply-Sourcing` · **Cliente:** `Studio Minah`
