...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`William`**
### Nome preferido / como é chamado(a)
**William**
### Email
**`william.assumpcao@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **29/01/2024** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu- Planejamento`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `29/01/2024`.** Não deduzi a data. ⚠ **Sem acesso a:** `Meus produtos`.
