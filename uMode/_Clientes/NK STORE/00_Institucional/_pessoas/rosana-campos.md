...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`ROSANA RIBEIRO DA SILVA CAMPOS`**
### Nome preferido / como é chamado(a)
**ROSANA RIBEIRO DA SILVA CAMPOS**
### Email
**`rosana.campos@nkstore.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
**Observação da fonte:** perfil de acesso `NK - PCP`. ⚠ **O nome está em CAIXA ALTA na fonte** — mantido como está, `protocolo-varredura-cliente.md` § 9.
