...
>
> 🔴 **Este é o único lugar onde se pergunta "o que ainda não sei sobre o Highstil?" e
...
|--:|---|:-:|---|
| 1 | ⚠ **`Churn` com atendente nomeado em 2025 e linha editada em 22/09/2026.** | `T2` | confirmado pelo Vinicius: **foi churn mesmo** (corte de gastos) |
| 2 | ⚠ **Ativação em 11/02/2025** — coorte de fev/2025 com Recco e Lenny. | `T2` | — |
...
### 3.1 · Varridas para a carteira inteira — valem para o Highstil
...
**Cliente:** `Highstil` — [institucional.md](institucional.md) · [jornada.md](jornada.md) · [pessoas.md](pessoas.md)
