...
- id: susie-modas — [varredura do Notion · 2026-09-22]
...
`[a preencher]` — campo **`situacao` vazio na planilha de contratos do Financeiro**.
...
### 🔴 A frente aberta
🔴 **Chamado `FINANCEIRO` em 13/01/2026**, numa conta `Inativo`.
