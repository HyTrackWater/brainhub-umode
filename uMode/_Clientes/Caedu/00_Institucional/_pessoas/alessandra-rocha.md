...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`alessandra rocha`**
### Nome preferido / como é chamado(a)
**alessandra rocha**
### Email
**`alessandra.rocha@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **[a preencher]** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu-Gerentes`, da tabela de usuários da página do cliente. ⚠ **Sem acesso a:** `Aba de cadastros`, `Meus produtos`.
