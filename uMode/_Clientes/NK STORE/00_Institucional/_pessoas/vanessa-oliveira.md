...
**Vanessa**
### Email
**`vanessa.oliveira@nkstore.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
**Observação da fonte:** perfil de acesso `NK - Modelagem`. ⚠ **Segunda `Vanessa` da base** (com `Vanessa Veiga`, `vanessa.ventura`) — não fundi.
