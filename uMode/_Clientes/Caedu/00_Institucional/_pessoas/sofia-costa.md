...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`sofia costa`**
### Nome preferido / como é chamado(a)
**sofia costa**
### Email
**`sofia.costa@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **24/11/0202** |
