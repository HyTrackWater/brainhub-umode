...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`jorge silva`**
### Nome preferido / como é chamado(a)
**jorge silva**
### Email
**`jorge.silva@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **10/04/2024** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu-Produto`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `10/04/2024`.** Não deduzi a data. ⚠ **Sem acesso a:** `Aba de cadastros`, `Meus produtos`.
