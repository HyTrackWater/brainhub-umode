...
- pessoas-da-area: 2 pessoa(s) com acesso ao PLM nesta área: — [página Puket, tabela do PLM · 2026-09-21]
- responsavel-area: ? — [não consta em: página Puket, tabela do PLM · 2026-09-21]

## O que esta área faz

🔴 **A Controladoria participa do fluxo de produto — e é a única menção de área financeira na conta:**
...
🔴 **`custo estimado` está entre os campos apontados como subutilizados** (§ 1, Principais Achados).
...
## Pessoas desta área
**2 pessoa(s)** com acesso ao PLM nesta área:

- `Controladoria` — 1 pessoa(s)
- `Controladoria [RISCADO na origem]` — 1 pessoa(s)

**Distribuição por domínio:** grupounico.com: 2
...
**Área:** `11_Financeiro` · **Cliente:** `Puket`
