...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Nelson Tadeu Alves Ferreira`**
### Nome preferido / como é chamado(a)
**Nelson Tadeu Alves Ferreira**
### Email
**`expedicao2@nkstore.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
### Área (organizacional)
**Compras** — **`Departamento NK`** na tabela de usuários da plataforma.
...
| **Status na base** | **CONVITE ACEITO em 06/01/2025** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `NK - Compras`. 🔴 **E-mail FUNCIONAL, não nominal** (`expedicao2@`) com pessoa nomeada atrás. ⚠ **A chave de identidade aqui é de uma CAIXA, não de uma pessoa** — e o `2` sugere que existe uma `expedicao1`.
