---
aliases:
  - "Planejamento e Controle da Produção · Contexto de área — Puket"
tags:
  - tipo/area
  - cliente/puket
  - status/ongoing
...
- pessoas-da-area: 1 pessoa(s) com acesso ao PLM nesta área: — [página Puket, tabela do PLM · 2026-09-21]
- responsavel-area: ? — [não consta em: página Puket, tabela do PLM · 2026-09-21]

## O que esta área faz

⚠ **Não há área de PCP nomeada na Puket.** O que existe é a lacuna que um PCP cobriria — **planejado contra realizado por etapa**:
...
🔴 **Há também etapa de Kanban que o time não usa:** *"Aguardando amostras showroom"* (§ 4.1).
...
## Pessoas desta área
**1 pessoa(s)** com acesso ao PLM nesta área:

- `PCP` — 1 pessoa(s)

**Distribuição por domínio:** puket.com.br: 1
