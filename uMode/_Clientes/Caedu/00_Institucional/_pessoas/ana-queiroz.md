...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`ana queiroz`**
### Nome preferido / como é chamado(a)
**ana queiroz**
### Email
**`ana.queiroz@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **06/09/2023 1** |
