...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`paulo pelaes`**
### Nome preferido / como é chamado(a)
**paulo pelaes**
### Email
**`paulo.pelaes@grupounico.com`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **23/09/2022** |
