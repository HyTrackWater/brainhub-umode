---
aliases:
  - "NK STORE · Pessoa · Isabely Consul Dantas"
tags:
  - tipo/pessoa
  - cliente/nk-store
  - status/ongoing
...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Isabely Consul Dantas`**
### Nome preferido / como é chamado(a)
**Isabely Consul Dantas**
### Email
**`isabely.consul@nkstore.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
**Observação da fonte:** perfil de acesso `NK - Compras`.
