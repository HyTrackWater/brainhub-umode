...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`BIANCA FONSECA`**
### Nome preferido / como é chamado(a)
**BIANCA FONSECA**
### Email
**`bianca.werneck@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **22/11/0202** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu-Produto`, da tabela de usuários da página do cliente. ⚠ **Sem acesso a:** `Aba de cadastros`.
