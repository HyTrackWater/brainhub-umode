---
aliases:
  - "Puket · Pessoa · luciene comenalli"
tags:
  - tipo/pessoa
  - cliente/puket
  - status/ongoing
...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`luciene comenalli`**
### Nome preferido / como é chamado(a)
**luciene comenalli**
### Email
**`luciene.comenalli@grupounico.com`** — e-mail **corporativo**, da tabela de usuários da plataforma.
