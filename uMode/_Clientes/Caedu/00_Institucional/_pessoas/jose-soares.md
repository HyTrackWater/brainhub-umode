...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`jose soares`**
### Nome preferido / como é chamado(a)
**jose soares**
### Email
**`jose.soares@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **14/11/20** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu-Produto`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `14/11/20`.** Não deduzi a data. ⚠ **Sem acesso a:** `Aba de cadastros`, `Meus produtos`.
