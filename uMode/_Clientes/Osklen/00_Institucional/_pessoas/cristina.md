...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Maria Cristina Cipriano do Carmo`**
### Nome preferido / como é chamado(a)
**Maria Cristina Cipriano do Carmo**
### Email
**`cristina@osklen.com.br`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
...
### Área (organizacional)
**Supply** — **`Área — auto-declarada na Pesquisa de Satisfação`** na tabela de usuários da plataforma.
