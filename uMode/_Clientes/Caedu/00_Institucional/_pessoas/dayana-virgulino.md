...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Dayana Layna`**
### Nome preferido / como é chamado(a)
**Dayana Layna**
### Email
**`dayana.virgulino@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **08/05/2024** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu-Geral`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `08/05/2024`.** Não deduzi a data. ⚠ **Sem acesso a:** `Aba de cadastros`.
