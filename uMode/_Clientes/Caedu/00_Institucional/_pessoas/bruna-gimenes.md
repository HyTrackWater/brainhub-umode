...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`bruna gimenes`**
### Nome preferido / como é chamado(a)
**bruna gimenes**
### Email
**`bruna.gimenes@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
**Observação da fonte:** perfil de acesso `Caedu-Estilo`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `04/09/2023`.** Não deduzi a data. ⚠ **Sem acesso a:** `Aba de cadastros`.
