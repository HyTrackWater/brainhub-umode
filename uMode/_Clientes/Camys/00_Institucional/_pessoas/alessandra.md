...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`DIGITAL, SAC & INSIDe`**
### Nome preferido / como é chamado(a)
**DIGITAL, SAC & INSIDe**
### Email
**`alessandra@camys.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
### Área (organizacional)
**Gerente de Produto** — **`Perfil de Acesso`** na tabela de usuários da plataforma.
...
⚠ **não se aplica** — esta pessoa **é** do cliente `Camys`
...
| **Ativo na plataforma desde** | **29/07/2021** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** 🔴 **A coluna `Usuário` traz um NOME DE FUNÇÃO, não de pessoa** — `DIGITAL, SAC & INSIDe` — com um e-mail nominal (`alessandra@`). **Conta compartilhada ou rótulo errado: não decidi.** ⚠ O perfil é `Camys - Gerente de Produto`, que não bate com o rótulo da função.
...
**Cliente:** `Camys` — [institucional.md](../_contexto/institucional.md) · [jornada.md](../_contexto/jornada.md) · [pessoas.md](../_contexto/pessoas.md)
