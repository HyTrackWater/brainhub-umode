...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Marcela Polyana`**
### Nome preferido / como é chamado(a)
**Marcela Polyana**
### Email
**`marcela.figueiredo@puket.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **20/06/2022** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** ⚠ **nome e e-mail divergem** (`Polyana` × `figueiredo`) — não resolvi
