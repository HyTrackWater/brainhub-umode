# Compras, Supply e Sourcing · Contexto de área — Lofty Style
...
## Pessoas desta área
**Gabriela Cunha** (como `Sourcing / compras`, mar/2025) · **Victoria Silva** (`Sourcing`) · **Brenda Santana** (`Compras`), ambas em out/2025.

⚠ **Três rótulos diferentes para a mesma área** — `Sourcing`, `Compras` e `Sourcing / compras` — **porque o campo de área da pesquisa é texto livre.**

**Victoria Silva abriu chamado `TAREFA/CONFIG` em 14/01/2026.**

⚠ **A Gabriela migrou para Estilo entre as duas pesquisas** — ver `02_Estilo-Criacao`.
...
**Área:** `06_Compras-Supply-Sourcing` · **Cliente:** `Lofty Style`
