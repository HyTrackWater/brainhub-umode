...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`gabriela begnini`**
### Nome preferido / como é chamado(a)
**gabriela begnini**
### Email
**`gabriela.begnini@grupounico.com`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **24/05/2022** |
