...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Andreza`**
### Nome preferido / como é chamado(a)
**Andreza**
### Email
**`andreza.maia@lennyniemeyer.com`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
...
### Área (organizacional)
**Modelista de Lycra** — **`Área — auto-declarada na Pesquisa de Satisfação`** na tabela de usuários da plataforma.
