...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`bruno moreira`**
### Nome preferido / como é chamado(a)
**bruno moreira**
### Email
**`bruno.moreira@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **11/10/2023** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu- Planejamento`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `11/10/2023`.** Não deduzi a data. ⚠ **Sem acesso a:** `Meus produtos`.
