...
### Aliases do cliente
`Mondpars` (corpus) · **`Mondepars`** (base `Mapa de Clientes`) — ⚠ **duas grafias**
...
O corpus tem a pasta **`Mondpars`** e a base `Mapa de Clientes` diz **`Mondepars`**.
