...
>
> 🟢 **Esta área é declarada pelo próprio cliente.** O campo *"Departamentos engajados"* do template de transição, na página da NV, lista **`Cadastro/Planners`**.
>
...
🔴 **É aqui que mora a dor principal da conta.** O *Manual de descancelamento de produtos e variantes* e a página *NV | Variantes Canceladas Inativas* tratam de cadastro de produto. E os **7 chamados `BURLAR PROCESSO`** da carteira inteira são desta conta — os dois que têm título dizem **"Descancelar produto"**.
...
**Área:** `08_Ecommerce-Cadastro` · **Cliente:** `NV`
