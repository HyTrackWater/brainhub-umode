...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`camila coutinho`**
### Nome preferido / como é chamado(a)
**camila coutinho**
### Email
**`camila.coutinho@osklen.com.br`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
...
### Área (organizacional)
**Estilo - Sneakers** — **`Área — auto-declarada na Pesquisa de Satisfação`** na tabela de usuários da plataforma.
