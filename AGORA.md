...
| Decisões pendentes | **669** | `_pendencias-gerais.md` — **triadas na § 0** |
...
| | |
|---|---:|
| fatos com fonte e data | **1.325** (39%) |
| 🔴 fatos `[sem fonte]` — **ninguém procurou** | **338** (10%) |
| 🟢 **SEIS clientes com ZERO `[sem fonte]`** | Caedu 142 · NK STORE 107 · Puket 92 · Luiza Barcelos 92 · Osklen 90 · Oficina Reserva 88 |
| 🟢 ausência VERIFICADA no corpus | **1.717** (51%) — fonte nomeada e data |
