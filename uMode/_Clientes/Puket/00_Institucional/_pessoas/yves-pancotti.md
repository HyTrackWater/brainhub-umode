...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`yves pancotti`**
### Nome preferido / como é chamado(a)
**yves pancotti**
### Email
**`yves.pancotti@puket.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **02/02/2023** |
