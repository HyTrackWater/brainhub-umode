...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Evelyn Vasques`**
### Nome preferido / como é chamado(a)
**Evelyn Vasques**
### Email
**`evelyn.reis@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **03/01/2024** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu-Estilo`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `03/01/2024`.** Não deduzi a data. ⚠ **Sem acesso a:** `Aba de cadastros`, `Meus produtos`.
