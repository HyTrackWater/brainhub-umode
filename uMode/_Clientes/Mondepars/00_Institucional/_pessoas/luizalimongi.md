...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Luiza`**
### Nome preferido / como é chamado(a)
**Luiza**
### Email
**`luizalimongi@mondepars.com`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
**Observação da fonte:** perfil `Dono`. ⚠ **Sem sobrenome na coluna `Usuário`** — o e-mail sugere `Limongi`, **não completei**.
