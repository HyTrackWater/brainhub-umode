---
aliases:
  - "E-commerce e Cadastro · Contexto de área — Reserva"
tags:
  - tipo/area
  - cliente/reserva
  - status/ongoing
...
## Pessoas desta área
**Raquel** — citada em *"Migração PA Umode"* junto de Cadastro, e no documento *Solicitações Raquel 21/06/23*. Estado `INDETERMINADO`.

> ⚠ Raquel aparece **também como Eng** em *"uMode - Importante"*. **Uma pessoa em duas áreas — ou duas pessoas com o mesmo primeiro nome.** Sem e-mail, **não dá para decidir.**

## Canais de comunicação desta área
- *"Migração PA uMode [Reserva]"* 🟢 **manter**
- *"Migração PA Umode"* → vira **grupo temporário por projeto** — Cadastro, Raquel
- *"PROBLEMAS DIÁRIOS PA"* 🟢 **manter** — **SAP, Linx, Cadastro RSV e Cadastro Oficina**

## Dores e frentes abertas
- 🔴 **Existe um grupo diário chamado *PROBLEMAS DIÁRIOS PA*.** O nome é o achado: a convivência de **dois ERPs (SAP e Linx)** com dois cadastros (**RSV e Oficina**) gera problema **com frequência diária** — a ponto de merecer canal próprio.
- **Dificuldade de exportação/edição do Mapa** — card aberto no board 18 desde jul/2024.
...
**Área:** `08_Ecommerce-Cadastro` · **Cliente:** `Reserva`
