...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`mariana basso`**
### Nome preferido / como é chamado(a)
**mariana basso**
### Email
**`mariana.basso@mondepars.com`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **09/12/2025** |
