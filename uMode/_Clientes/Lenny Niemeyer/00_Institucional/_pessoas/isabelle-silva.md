# Lenny Niemeyer · Pessoa · Isabelle
...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Isabelle`**
### Nome preferido / como é chamado(a)
**Isabelle**
### Email
**`isabelle.silva@lennyniemeyer.com`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
...
### Área (organizacional)
**Design** — **`Área — auto-declarada na Pesquisa de Satisfação`** na tabela de usuários da plataforma.
