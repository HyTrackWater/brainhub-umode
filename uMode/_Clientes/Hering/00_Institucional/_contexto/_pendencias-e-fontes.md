...
>
> 🔴 **Este é o único lugar onde se pergunta "o que ainda não sei sobre o Hering?" e
...
|--:|---|:-:|---|
| 1 | ⚠ **ERP `Ilimitar`** — não estava no corpus antes de 03 ago 2026. | `T2` | — |
...
### 3.1 · Varridas para a carteira inteira — valem para o Hering
...
**Cliente:** `Hering` — [institucional.md](institucional.md) · [jornada.md](jornada.md) · [pessoas.md](pessoas.md)
