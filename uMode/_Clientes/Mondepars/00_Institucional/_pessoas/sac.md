...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Carolina Abreu`**
### Nome preferido / como é chamado(a)
**Carolina Abreu**
### Email
**`sac@mondepars.com`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **06/04/2026** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil `Dono`. 🔴 **`sac@` é CAIXA FUNCIONAL, não endereço nominal** — **não serve como chave de identidade de pessoa** (item 252), porque outra pessoa do SAC teria o mesmo.
