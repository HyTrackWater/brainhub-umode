...
titulo: "Ana · Navegação Legado"
data: 2025-05-28
referente_a: 2025-05-28
destino: "[a preencher]"
...
tem_resumo: true
posicao_na_linha_do_tempo: 80/135
reunioes_depois: 55
idade_em_dias: 485
horizonte: historico
tier: T2
...
---
# Ana · Navegação Legado — 2025-05-28
...
| | |
|---|---|
| Reunião | **80 de 135** de destino não identificado nos acervos |
| Data | **2025-05-28** — **485 dias atrás** |
| Depois dela | **55 reuniões** — a última em **2026-09-22** |
...
**estava por vir naquela data**, e o cumprimento **não está verificado** — há **55 reuniões posteriores** onde conferir.

## ⚠ Fatos propostos — ainda NÃO são fatos

### ✅ Aconteceu — em 2025-05-28

- dor: Ela mencionou que a ausência de automação na TDC evita problemas com mudanças de regras. — [resumo Gemini 2025-05-28] ⚠ PROPOSTA · DERIVADA
