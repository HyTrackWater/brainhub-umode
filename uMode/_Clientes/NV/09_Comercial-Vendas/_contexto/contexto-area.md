---
aliases:
  - "Comercial e Vendas · Contexto de área — NV"
tags:
  - tipo/area
  - cliente/nv
  - status/ongoing
...
>
> 🟢 **Esta área é declarada pelo próprio cliente.** O campo *"Departamentos engajados"* do template de transição, na página da NV, lista **`Atacado`**.
>
...
**A NV tem DOIS perfis comerciais: `NV - Atacado` e `NV - Planejamento Comercial`.**

⚠ **`Planejamento Comercial` não é o mesmo que `01_Planejamento`** — a conta tem os dois, e também `NV - Planner` e `NV - Planner 2`. 🔴 **São quatro perfis com "plan" no nome e funções diferentes.** **Armadilha de leitura, como `Oficina - Planner` × `Oficina - Planejamento`.**
...
**Área:** `09_Comercial-Vendas` · **Cliente:** `NV`
