...
⚠ **suspeita de mesma origem que `Totvs Moda`** — não fundidos
...
|---|---|---|
| [Highstil](../../_Clientes/Highstil/00_Institucional/_contexto/institucional.md) | `Churn` | `Totvs` |
| [Recco](../../_Clientes/Recco/00_Institucional/_contexto/institucional.md) | `Churn` | `Totvs` |
