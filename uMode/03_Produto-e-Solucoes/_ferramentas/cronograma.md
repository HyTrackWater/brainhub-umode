...
## Adoção
### Quantos clientes
**6** de 49 clientes do corpus
### Quais clientes
| Cliente | `Status` na base | Valor literal do campo |
|---|---|---|
| [Lofty Style](../../_Clientes/Lofty Style/00_Institucional/_contexto/institucional.md) | `Ongoing` | `Cronograma` |
| [Moda Objetiva](../../_Clientes/Moda Objetiva/00_Institucional/_contexto/institucional.md) | `Operação Assistida` | `Cronograma` |
| [NV](../../_Clientes/NV/00_Institucional/_contexto/institucional.md) | `Ongoing` | `Cronograma` |
| [Oficina Reserva](../../_Clientes/Oficina Reserva/00_Institucional/_contexto/institucional.md) | `Ongoing` | `Cronograma` |
| [Osklen](../../_Clientes/Osklen/00_Institucional/_contexto/institucional.md) | `Operação Assistida` | `Cronograma` |
| [Reserva](../../_Clientes/Reserva/00_Institucional/_contexto/institucional.md) | `Ongoing` | `Cronograma` |
