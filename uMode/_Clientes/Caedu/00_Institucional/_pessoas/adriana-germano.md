...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`adriana germano`**
### Nome preferido / como é chamado(a)
**adriana germano**
### Email
**`adriana.germano@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **21/07/2023** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu-Geral`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `21/07/2023`.** Não deduzi a data. ⚠ **Sem acesso a:** `Aba de cadastros`.
