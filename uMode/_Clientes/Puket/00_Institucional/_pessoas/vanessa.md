...
**Vanessa**
### Email
**`vanessa.facci@puket.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
⚠ **não se aplica** — esta pessoa **é** do cliente `Puket`
...
|---|---|
| **Demandas abertas** | **3** |
| Primeira atividade observada | 10/07/2025 |
| Última atividade observada | 13/11/2025 |
| Fonte | campo `Quem solicitou?` da base de demandas do Notion |
| **Ativo na plataforma desde** | **09/06/2022** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** também Vanesssa (1), com três esses
