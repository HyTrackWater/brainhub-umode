...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`vitoria meneghin`**
### Nome preferido / como é chamado(a)
**vitoria meneghin**
### Email
**`vitoria.meneghin@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **11/06/2024** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu-Admim`, da tabela de usuários da página do cliente. ⚠ **`Admim` está escrito assim na fonte** (erro de digitação por `Admin`). Não corrigi. 🔴 **`Ativo desde` está corrompido na fonte: `11/06/2024`.** Não deduzi a data. ⚠ **Sem acesso a:** `Meus produtos`.
