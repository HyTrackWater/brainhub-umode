...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`gabriela fonseca`**
### Nome preferido / como é chamado(a)
**gabriela fonseca**
### Email
**`gabriela.fonseca@puket.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **10/06/2022** |
