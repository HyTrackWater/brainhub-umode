...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`ana vilha`**
### Nome preferido / como é chamado(a)
**ana vilha**
### Email
**`ana.vilha@camys.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **07/06/2023** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Gerente de Estilo`.
