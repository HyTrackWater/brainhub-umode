...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`thais itice`**
### Nome preferido / como é chamado(a)
**thais itice**
### Email
**`thais.itice@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
### Área (organizacional)
**Qualidade** — **`Perfil de Acesso`** na tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **25/08/2023** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu-Qualidade`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `25/08/2023`.** Não deduzi a data. ⚠ **Sem acesso a:** `Aba de cadastros`, `Meus produtos`.
