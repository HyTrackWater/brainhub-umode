---
aliases:
  - "Comercial e Vendas · Contexto de área — Puket"
tags:
  - tipo/area
  - cliente/puket
  - status/ongoing
...
**O Showroom é o marco comercial do ciclo**, e ele depende do fechamento técnico:
...
🔴 **O canal atacado é campo obrigatório da ficha** (`Envio atacado`, § 4.2.3).
...
**Área:** `09_Comercial-Vendas` · **Cliente:** `Puket`
