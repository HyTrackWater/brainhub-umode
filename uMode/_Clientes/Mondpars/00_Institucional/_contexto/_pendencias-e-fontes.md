# Mondpars · Pendências e fontes varridas
...
>
> 🔴 **Este é o único lugar onde se pergunta "o que ainda não sei sobre o Mondpars?" e
...
### 3.1 · Varridas para a carteira inteira — valem para o Mondpars
...
**Cliente:** `Mondpars` — [institucional.md](institucional.md) · [jornada.md](jornada.md) · [pessoas.md](pessoas.md)
