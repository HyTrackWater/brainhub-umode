...
- id: seven-global — [varredura do Notion · 2026-09-22]
- segmento: Vestuário — [varredura do Notion · 2026-09-22]
...
### Quem são
**Vestuário**, em **São José dos Campos (SP)**.
...
- Luciano Troiani — 13 reuniões da conta
- Nayra Trentim — 12 reuniões da conta
- Marina Santoro — 2 reuniões da conta
...
`[a preencher]` — 🔴 **`Seven Global` não consta na planilha de contratos do Financeiro.**
