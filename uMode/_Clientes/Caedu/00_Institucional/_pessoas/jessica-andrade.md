...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`jessica andrade`**
### Nome preferido / como é chamado(a)
**jessica andrade**
### Email
**`jessica.andrade@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
### Área (organizacional)
**Geral + TM** — **`Perfil de Acesso`** na tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **01/04/2024** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu-Geral + TM`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `01/04/2024`.** Não deduzi a data. ⚠ **Sem acesso a:** `Meus produtos`.
