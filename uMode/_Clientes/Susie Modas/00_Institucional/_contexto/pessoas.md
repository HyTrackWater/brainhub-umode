...
> ⚠ **O próprio e-mail contém a palavra `inativo`** — `inativomidias.susie@gmail.com`. **Preservado da origem.** **Pode ser conta de mídia desativada usada para contato.**

| Pessoa | E-mail | Área | Estado | Evidência | Observação |
|---|---|---|---|---|---|
| `[a preencher]` | `inativomidias.susie@gmail.com` | `[a preencher]` | `ATIVO_SEM_CADASTRO` | chamado em **13/01/2026** | `FINANCEIRO` · ⚠ **e-mail pessoal com "inativo" no nome** |
