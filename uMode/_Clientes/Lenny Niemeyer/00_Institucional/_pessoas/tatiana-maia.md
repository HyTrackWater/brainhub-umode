---
aliases:
  - "Lenny Niemeyer · Pessoa · tatiana maia"
---
# Lenny Niemeyer · Pessoa · tatiana maia
...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`tatiana maia`**
### Nome preferido / como é chamado(a)
**tatiana maia**
### Email
**`tatiana.maia@lennyniemeyer.com`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
...
### Área (organizacional)
**Compras Matéria Prima** — **`Área — auto-declarada na Pesquisa de Satisfação`** na tabela de usuários da plataforma.
