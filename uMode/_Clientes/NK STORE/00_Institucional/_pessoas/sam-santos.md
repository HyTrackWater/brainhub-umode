...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Sam`**
### Nome preferido / como é chamado(a)
**Sam**
### Email
**`sam.santos@nkstore.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
### Área (organizacional)
**Estilo** — **`Departamento NK`** na tabela de usuários da plataforma.
...
| **Status na base** | **CONVITE ACEITO em 10/03/2025** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `NK - Estilo`. 🔴 **Esta pessoa aparece DUAS VEZES na base**, com o mesmo e-mail e a mesma data — linha duplicada na fonte.
