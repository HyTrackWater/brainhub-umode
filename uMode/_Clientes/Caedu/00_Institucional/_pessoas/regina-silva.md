...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Regina`**
### Nome preferido / como é chamado(a)
**Regina**
### Email
**`regina.silva@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **19/02/2024** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu- Planejamento`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `19/02/2024`.** Não deduzi a data. ⚠ **Sem acesso a:** `Meus produtos`.
