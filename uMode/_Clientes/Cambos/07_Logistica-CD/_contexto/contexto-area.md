---
aliases:
  - "Logística e Centro de Distribuição · Contexto de área — Cambos"
tags:
  - tipo/area
  - cliente/cambos
  - status/ongoing
...
>
> Times declarados: **Desenvolvimento** (Pesquisa, Criação, Modelagem e Pilotagem, divididos entre SP e MG) · **Comercial** · **Compras**.
>
...
⚠ **A página `Perfil de Usuário e Permissionamentos` existe e não foi varrida** — **é a próxima fonte a abrir nesta conta**, e pode mudar esta seção.
...
**Área:** `07_Logistica-CD` · **Cliente:** `Cambos`
