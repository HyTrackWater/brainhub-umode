...
## O que esta área faz
Qualificação de leads, fechamento de novos contratos e upsell.

## Com quem se relaciona (interno e externo)
[a detalhar com o responsável da área]

## Entregas e responsabilidades
Receita nova: Educação R$ 1M · SaaS R$ 400k · upsell +25% (meta 2026)

## Padrões operacionais
### Como trabalhamos
Fronteira clara com Operações: Operações origina/sinaliza, Vendas fecha.
...
**Área da Casa uMode:** `01_Comercial`
