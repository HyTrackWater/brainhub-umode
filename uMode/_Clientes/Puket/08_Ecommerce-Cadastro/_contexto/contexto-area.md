---
aliases:
  - "E-commerce e Cadastro · Contexto de área — Puket"
tags:
  - tipo/area
  - cliente/puket
  - status/ongoing
...
**O cadastro alimenta o e-commerce pela integração com o Linx**, e o campo `Envio site` é o que autoriza o canal:

> *"Campos de 'Envio loja', '**Envio site**', 'Envio atacado' (...) obrigatórios para definir a distribuição e geração de NFs."* — § 4.2.3

🔴 **E o escopo do mapeamento exclui integração nova de e-commerce, por já existir:**
> *"**Não incluso**: (...) integrações adicionais de e-commerce (já em Link c/ Linx)."* — § 2.2
...
**Área:** `08_Ecommerce-Cadastro` · **Cliente:** `Puket`
