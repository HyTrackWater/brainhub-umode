...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`brida duch`**
### Nome preferido / como é chamado(a)
**brida duch**
### Email
**`brida.duch@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **27/11/0202** |
