...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`nathalia garcia`**
### Nome preferido / como é chamado(a)
**nathalia garcia**
### Email
**`nathalia.garcia@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **06/09/2023** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu-Estilo`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `06/09/2023`.** Não deduzi a data. ⚠ **Sem acesso a:** `Aba de cadastros`.
