...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Michelle`**
### Nome preferido / como é chamado(a)
**Michelle**
### Email
**`michelle.lemos@osklen.com.br`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
...
### Área (organizacional)
**Qualidade e Acabamento** — **`Área — auto-declarada na Pesquisa de Satisfação`** na tabela de usuários da plataforma.
