---
aliases:
  - "Compras, Supply e Sourcing · Contexto de área — TDC"
tags:
  - tipo/area
  - cliente/tdc
  - status/sem-cs
...
- pessoas-da-area: ? — [não consta em: página TDC — 🔴 nenhuma fonte de pessoa por área encontrada · 2026-09-23]
- responsavel-area: ? — [não consta em: página TDC — 🔴 nenhuma fonte de pessoa por área encontrada · 2026-09-23]
...
| Pessoas e responsáveis de área | Notion — página `TDC` — 🔴 **nenhuma fonte de pessoa por área encontrada** | varrido 23/09/2026 |
...
**Área:** `06_Compras-Supply-Sourcing` · **Cliente:** `TDC`
