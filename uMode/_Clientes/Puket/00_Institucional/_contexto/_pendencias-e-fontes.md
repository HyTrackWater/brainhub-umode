...
>
> 🔴 **Este é o único lugar onde se pergunta "o que ainda não sei sobre o Puket?" e
...
|--:|---|:-:|---|
| 1 | ⚠ **Só 2 módulos contratados** (`Gestão de Coleção`, `Integração`) — o menor entre os `Ongoing`. | `T2` | — |
| 2 | ⚠ **ERP `Linx / SAP`** — valor composto. **Não desmembrei em dois vínculos:** a fonte não diz se usa os dois ou um para cada coisa. | `T2` | conferência |
...
### 3.1 · Varridas para a carteira inteira — valem para o Puket
