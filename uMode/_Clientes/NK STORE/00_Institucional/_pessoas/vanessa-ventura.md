...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Vanessa Veiga`**
### Nome preferido / como é chamado(a)
**Vanessa Veiga**
### Email
**`vanessa.ventura@nkstore.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Status na base** | **USUÁRIO INATIVO desde 10/03/2025** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `NK - Estilo`. 🔴 **Única linha da base com status de INATIVO de fato.** ⚠ **Nome e e-mail divergem** (`Veiga` × `ventura`) — não resolvi.
