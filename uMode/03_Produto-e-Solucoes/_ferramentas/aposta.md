...
## Adoção
### Quantos clientes
**2** de 49 clientes do corpus
### Quais clientes
| Cliente | `Status` na base | Valor literal do campo |
|---|---|---|
| [Reserva](../../_Clientes/Reserva/00_Institucional/_contexto/institucional.md) | `Ongoing` | `Aposta` |
| [VIX](../../_Clientes/VIX/00_Institucional/_contexto/institucional.md) | `Ongoing` | `Aposta` |
