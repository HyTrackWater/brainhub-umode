...
| 🚨 [`_parte-iv-ontologia-como-requisito.md`](uMode/00_Institucional/_contexto/_parte-iv-ontologia-como-requisito.md) — **a devolutiva do Vinicius ao plano do João e à Parte III do Pedro. Não é evolução, é acréscimo com divergência declarada. O que falta nos dois planos não é a entidade — é a CHAVE. E o pedido do Rafael de devolver as TELAS segue aberto** ·
...
| 🚨 [`_dicionario-de-papeis-e-enderecamento.md`](uMode/00_Institucional/_contexto/_dicionario-de-papeis-e-enderecamento.md) — **dono da tradução papel → `pessoa:<e-mail>`. 98% dos MDs-alvo têm dono, mas 0% vira pessoa — e o papel mais usado, em 1.219 documentos, NÃO resolve** ·
...
[`prompt-agente-classificador-de-call.md`](uMode/00_Institucional/_protocolos/prompt-agente-classificador-de-call.md) ·
...
🚨 [`_varredura-2026-09-23h-os-agentes-do-vault-e-o-moedor-que-ja-foi-desenhado.md`](uMode/00_Institucional/_contexto/_varredura-2026-09-23h-os-agentes-do-vault-e-o-moedor-que-ja-foi-desenhado.md) — **o moedor JÁ FOI DESENHADO pelo João em 17/06 e chegou a rodar uma vez; 206 transcrições e 598 áudios parados; 16 jobs pausados** ·
🚨 [`_varredura-2026-09-24-os-exports-nao-lidos-do-vault.md`](uMode/00_Institucional/_contexto/_varredura-2026-09-24-os-exports-nao-lidos-do-vault.md) — **o corpus só tinha aberto 1 dos 6 exports do vault. Health score interno de 24 clientes, e metade da carteira nunca foi avaliada. O formulário que preencheria `Resultado esperado` existe e foi usado 2 vezes** ·
