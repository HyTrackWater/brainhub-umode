# NK STORE · Pessoa · moreno ribeiro
...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`moreno ribeiro`**
### Nome preferido / como é chamado(a)
**moreno ribeiro**
### Email
**`moreno.ribeiro@nkstore.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Status na base** | **CONVITE ACEITO em 13/02/2025** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `NK - Estilo`.
