...
**É `Suprimentos` na estrutura da Diretoria Criativa**, com Gerente de Levantamento de Suprimentos nomeado.

⚠ **Foi a única área que NÃO coube na agenda presencial do Kick Off:**
> *"Fechar agenda da **reunião online com Suprimentos**."*

🔴 **E aparece com outro nome na ata de Kick Off Interno:** *"Times: Estilo, PCP, **Compras**"* — **`Compras` e `Suprimentos` são o mesmo time com dois nomes na mesma página.**
