...
`[a preencher]`
### Nome completo
**Romulo Smaniotto** — da página do cliente. A base de demandas a escreve como `Romulo Smaniotto`.
### Nome preferido / como é chamado(a)
**Romulo Smaniotto**
### Email
**`romulo.smaniotto@luizabarcelos.com.br`** — e-mail **corporativo**, da página do cliente.
...
### Área (organizacional)
**Desenvolvimento** — ⚠ **como a fonte a nomeia**, não necessariamente uma das
