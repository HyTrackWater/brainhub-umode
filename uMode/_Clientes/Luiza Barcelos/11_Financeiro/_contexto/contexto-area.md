...
>
> **Time declarado:** — (não listada em *Times Envolvidos*)
>
...
⚠ **A área não está entre os *Times Envolvidos* do projeto**, mas tem responsável nomeado. **Está na conta, não no projeto.**

⚠ **O e-mail financeiro está na página e o campo `Email Principal Financeiro` da base está VAZIO** — **mesmo padrão da Cambos.**

⚠ **E `Precificação`, que é sub-time de Operações, não foi encaixada aqui.** **Precificação em moda costuma ser comercial ou merchandising, não financeiro.** **Não forçei.**
...
## Pessoas desta área
**Ana Lucia Andrade** — **Responsável pelo Financeiro** · e-mail `[a preencher]`

**E-mail principal financeiro da conta:** `luiz@luizabarcelos.com.br`
...
**Área:** `11_Financeiro` · **Cliente:** `Luiza Barcelos`
