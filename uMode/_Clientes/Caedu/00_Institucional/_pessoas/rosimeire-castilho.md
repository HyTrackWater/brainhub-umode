...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`rosimeire castilho`**
### Nome preferido / como é chamado(a)
**rosimeire castilho**
### Email
**`rosimeire.castilho@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **13/05/2024** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu-Geral + TM`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `13/05/2024`.** Não deduzi a data. ⚠ **Sem acesso a:** `Meus produtos`.
