...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`João`**
### Nome preferido / como é chamado(a)
**João**
### Email
**`joaopaz@mondepars.com`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **23/03/2026** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil `Dono`. ⚠ **Sem sobrenome na coluna `Usuário`** — o e-mail sugere `Paz`, **não completei**.
