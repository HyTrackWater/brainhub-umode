...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`jose prior`**
### Nome preferido / como é chamado(a)
**jose prior**
### Email
**`jose.prior@osklen.com.br`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
...
### Área (organizacional)
**Operações** — **`Área — auto-declarada na Pesquisa de Satisfação`** na tabela de usuários da plataforma.
