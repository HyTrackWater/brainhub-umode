---
aliases:
  - "Lenny Niemeyer · Pessoa · amanda martino"
---
# Lenny Niemeyer · Pessoa · amanda martino
...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`amanda martino`**
### Nome preferido / como é chamado(a)
**amanda martino**
### Email
**`amanda.martino@lennyniemeyer.com`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
