...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Victor`**
### Nome preferido / como é chamado(a)
**Victor**
### Email
**`victor.ponte@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **16/07/2024** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu- Planejamento`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `16/07/2024`.** Não deduzi a data. ⚠ **Sem acesso a:** `Meus produtos`.
