...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`thays pantaleao`**
### Nome preferido / como é chamado(a)
**thays pantaleao**
### Email
**`thays.pantaleao@osklen.com.br`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
...
### Área (organizacional)
**Design de moda - acessórios/ calçados** — **`Área — auto-declarada na Pesquisa de Satisfação`** na tabela de usuários da plataforma.
