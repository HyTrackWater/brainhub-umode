...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Isabela Pereira`**
### Nome preferido / como é chamado(a)
**Isabela Pereira**
### Email
**`isabela.cipriani@grupounico.com`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
### Área (organizacional)
**Importação** — **`Perfil de Acesso`** na tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **19/06/2023** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** ⚠ **nome e e-mail divergem** (`Pereira` × `cipriani`) — não resolvi
