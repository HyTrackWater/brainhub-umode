...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`karina ossugui`**
### Nome preferido / como é chamado(a)
**karina ossugui**
### Email
**`karina.ossugui@puket.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
### Área (organizacional)
**Design** — **`Perfil de Acesso`** na tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **20/12/2022** |
