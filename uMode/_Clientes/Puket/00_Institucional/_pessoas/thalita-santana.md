...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`thalita santana`**
### Nome preferido / como é chamado(a)
**thalita santana**
### Email
**`thalita.santana@puket.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **14/12/2022** |
