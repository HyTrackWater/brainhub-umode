...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`jessica bognar`**
### Nome preferido / como é chamado(a)
**jessica bognar**
### Email
**`jessica.bognar@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **14/03/2024** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu-Produto`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `14/03/2024`.** Não deduzi a data. ⚠ **Sem acesso a:** `Aba de cadastros`, `Meus produtos`.
