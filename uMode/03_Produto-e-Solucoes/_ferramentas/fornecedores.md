...
## Adoção
### Quantos clientes
**7** de 49 clientes do corpus
### Quais clientes
| Cliente | `Status` na base | Valor literal do campo |
|---|---|---|
| [Baw](../../_Clientes/Baw/00_Institucional/_contexto/institucional.md) | `Sem CS` | `Fornecedores` |
| [Caedu](../../_Clientes/Caedu/00_Institucional/_contexto/institucional.md) | `Onboarding` | `Fornecedores` |
| [Luiza Barcelos](../../_Clientes/Luiza Barcelos/00_Institucional/_contexto/institucional.md) | `Ongoing` | `Fornecedores` |
| [NK STORE](../../_Clientes/NK STORE/00_Institucional/_contexto/institucional.md) | `Ongoing` | `Fornecedores` |
| [Oficina Reserva](../../_Clientes/Oficina Reserva/00_Institucional/_contexto/institucional.md) | `Ongoing` | `Fornecedores` |
| [Osklen](../../_Clientes/Osklen/00_Institucional/_contexto/institucional.md) | `Operação Assistida` | `Fornecedores` |
| [Reserva](../../_Clientes/Reserva/00_Institucional/_contexto/institucional.md) | `Ongoing` | `Fornecedores` |
