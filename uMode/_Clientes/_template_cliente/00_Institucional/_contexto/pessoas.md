...
**[Nome]** · [Cargo]
- Área: [área canônica]
- Papel: decisor / executor / informado
- email · telefone
...
- **Todo estado carrega a data da evidência.** Estado sem data não vale.
- **`DESATIVADO` só com marcação na fonte.** Nunca por inferência de inatividade.
...
> indexação do cérebro vai ligar pessoa ↔ ferramenta ↔ área.
