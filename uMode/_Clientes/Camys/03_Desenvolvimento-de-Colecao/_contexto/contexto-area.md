---
aliases:
  - "Desenvolvimento de Coleção · Contexto de área — Camys"
tags:
  - tipo/area
  - cliente/camys
  - status/sem-cs
...
- pessoas-da-area: ? — [não consta em: página Camys — 🔴 nenhuma fonte de pessoa por área encontrada · 2026-09-23]
- responsavel-area: ? — [não consta em: página Camys — 🔴 nenhuma fonte de pessoa por área encontrada · 2026-09-23]
...
| Pessoas e responsáveis de área | Notion — página `Camys` — 🔴 **nenhuma fonte de pessoa por área encontrada** | varrido 23/09/2026 |
...
**Área:** `03_Desenvolvimento-de-Colecao` · **Cliente:** `Camys`
