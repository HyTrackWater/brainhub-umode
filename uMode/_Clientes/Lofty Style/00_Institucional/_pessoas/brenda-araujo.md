...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Brenda Santana`**
### Nome preferido / como é chamado(a)
**Brenda Santana**
### Email
**`brenda.araujo@loftystyle.com.br`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
