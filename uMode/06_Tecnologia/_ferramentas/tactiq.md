...
**`Tactiq`**
### Natureza
**Canal / ferramenta de trabalho** — software de terceiro que a uMode opera. 🔴 **Não é produto da uMode e não é ERP de cliente.**
### Fornecedor
Tactiq
### Observação de taxonomia
🔴 **transcrição de reunião, e tem histórico próprio fora do Notion.** As 7 transcrições da CAEDU entregues pelo Vinícius são dela, e a página da Loungerie tem link vivo para um transcript. ⚠ **Nunca varrido — e é onde vive a fala real das reuniões.**

## Adoção
### Quantos clientes
**0** de 49 clientes do corpus
### Quais clientes
🔴 **Nenhum.** A opção existe no enum e **nenhum cliente a usa.**
...
🔴 **O vínculo com cliente NÃO vem de campo de base** — nenhuma base diz quem usa o quê. Vem de **citação na página do cliente**, e só existe onde a página foi aberta. **Lista vazia aqui significa "não varrido", nunca "não usado".**
### Áreas que usam
