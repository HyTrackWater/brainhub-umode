...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`EMILLY`**
### Nome preferido / como é chamado(a)
**EMILLY**
### Email
**`emilly.lima@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
**Observação da fonte:** perfil de acesso `Caedu-Modelagem`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `05/09/2023`.** Não deduzi a data. ⚠ **Sem acesso a:** `Aba de cadastros`, `Mapa de Produtos`.
