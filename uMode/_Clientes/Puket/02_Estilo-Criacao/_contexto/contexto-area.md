---
aliases:
  - "Estilo e Criação · Contexto de área — Puket"
tags:
  - tipo/area
  - cliente/puket
  - status/ongoing
...
- pessoas-da-area: 8 pessoa(s) com acesso ao PLM nesta área: — [página Puket, tabela do PLM · 2026-09-21]
...
## Pessoas desta área
**8 pessoa(s)** com acesso ao PLM nesta área:

- `Estilo` — 8 pessoa(s)

**Distribuição por domínio:** puket.com.br: 7 · grupounico.hk: 1
...
**Área:** `02_Estilo-Criacao` · **Cliente:** `Puket`
