---
aliases:
  - "Compras, Supply e Sourcing · Contexto de área — Osklen"
tags:
  - tipo/area
  - cliente/osklen
...
> **`Pesquisa Satisfação Kick Off Osklen`** — **33 pessoas com nome, e-mail, ÁREA, entusiasmo, CSat, expectativa e ressalva**.
>
...
- pessoas-da-area: 8 pessoas — [Pesquisa Satisfação Kick Off Osklen · 2025-03-25]
- responsavel-area: ? — [sem fonte]

## O que esta área faz
🔴 **É a área que mais teme a integração.** Quatro das seis ressalvas sobre Linx são daqui. A mais dura, de **Bruno Soares**:

> *"A integração é um ponto preocupante **dado o histórico recente e qualidade do nosso cadastro**."*

E **Maria Cristina** resume a ressalva dela em duas palavras: *"**com os cadastros**"* — dando CSat **8**, um dos dois mais baixos da conta.

🟢 **O módulo `Fornecedores` está contratado**, e há uma preocupação registrada sobre **receptividade dos fornecedores à plataforma** — **mesma da Oficina Reserva**.
...
## Pessoas desta área
**8 pessoas** — a maior área da conta.

**Aline Castro** · **Bruno Soares** · **Mariana Coelho** · **Maria Cristina Cipriano do Carmo** · **Carol** · **Janaina** · **Henrique Camacho** (todos `Supply`) · **Carlos Chermont** (`Gerente de compras`, ⚠ **e-mail pessoal**).

## Produto conectado
`Gestão de Coleção` · `Fornecedores` · `Integração` · `Cronograma` · `Relatórios` — **5 de 7**. ERP **`Linx`**. E **`uBuy` iniciado em jan/2026**.
...
**FAQ → Osklen & uMode 2026** · as duas páginas duplicadas de *Integração de Escrita* ·
os **11 documentos de implantação listados sem link** · as 2 bases de Reuniões Compartilhadas.
...
**Área:** `06_Compras-Supply-Sourcing` · **Cliente:** `Osklen`
