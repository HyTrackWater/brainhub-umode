...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`julia fontoura`**
### Nome preferido / como é chamado(a)
**julia fontoura**
### Email
**`julia.fontoura@nkstore.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
**Observação da fonte:** perfil de acesso `NK - Estilo`. 🔴 **`Departamento NK` = `INATIVAR`** — ⚠ **não é departamento, é INSTRUÇÃO OPERACIONAL escrita no campo de área.** Não afirmo que saiu: afirmo que a fonte pede a inativação.
