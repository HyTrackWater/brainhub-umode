...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Carmen Manzano`**
### Nome preferido / como é chamado(a)
**Carmen Manzano**
### Email
**`carmenmanzano@mondepars.com`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **10/12/2025** |
