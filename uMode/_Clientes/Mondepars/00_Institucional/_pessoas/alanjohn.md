...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Alan John`**
### Nome preferido / como é chamado(a)
**Alan John**
### Email
**`alanjohn@mondepars.com`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **04/03/2026** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil `Dono` — ver nota de Paula Bueno.
