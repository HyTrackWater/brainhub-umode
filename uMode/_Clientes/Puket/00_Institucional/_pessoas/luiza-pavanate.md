...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`luiza pavanate`**
### Nome preferido / como é chamado(a)
**luiza pavanate**
### Email
**`luiza.pavanate@grupounico.com`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **21/09/2022** |
