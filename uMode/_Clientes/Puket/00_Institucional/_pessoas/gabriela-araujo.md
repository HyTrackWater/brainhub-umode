...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`gabriela araujo`**
### Nome preferido / como é chamado(a)
**gabriela araujo**
### Email
**`gabriela.araujo@puket.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **03/06/2022** |
