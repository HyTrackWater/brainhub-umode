...
`[a preencher]`
### Nome completo
**Stella Sunaga** — da página do cliente. A base de demandas a escreve como `Stella Sunaga`.
### Nome preferido / como é chamado(a)
**Stella Sunaga**
### Email
**`stella.sunaga@nkstore.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
Fonte: página do cliente no Notion, toggle `Pessoas` › `Líderes de Departamentos`.
### Nível HIC
...
### Observação da fonte
a fonte anota: *"Há 10 anos na empresa"*
