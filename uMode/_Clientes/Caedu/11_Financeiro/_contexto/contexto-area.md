...
🔴 **A expressão `time financeiro` aparece **1 vez** nas 53 transcrições.**
...
**13 das 53 reuniões tocam esta área.** As mais densas:

| Data | Reunião | Menções |
|---|---|---:|
| 12/03/2026 | Weekly quinzenal CAEDU | 12 |
| 24/07/2024 | Sugestões B2B CAEDU | 10 |
| 23/07/2024 | Caedu - Importação | 10 |
| 07/01/2026 | Weekly quinzenal CAEDU | 9 |
| 19/07/2024 | Weekly CAEDU | 8 |
| 08/07/2025 | Caedu uMode - erro integrar status backlog e | 7 |
| 22/04/2025 | Alinhamento Caedu | 7 |
| 15/07/2024 | uMode <> Caedu Bi-Weekly | 7 |

⚠ **Termos contados:** `custo` · `margem` · `ncm` · `fiscal`.
