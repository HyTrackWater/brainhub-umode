# Lofty | RFI : Escopo - Integração de Imagens de Produto · RFI
...
## Conteúdo
### Nome / Descrição
Lofty | RFI : Escopo - Integração de Imagens de Produto
### Resumo do assunto
Integração de Imagens de Produto - da uMode para Linx
