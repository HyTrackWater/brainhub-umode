...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`camila blaudt`**
### Nome preferido / como é chamado(a)
**camila blaudt**
### Email
**`camila.blaudt@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **05/09/2023** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu-Modelagem`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `05/09/2023`.** Não deduzi a data. ⚠ **Sem acesso a:** `Aba de cadastros`, `Meus produtos`.
