...
`[a preencher]`
### Nome completo
**Janaina** — da página do cliente. A base de demandas a escreve como `Janaina`.
### Nome preferido / como é chamado(a)
**Janaina**
### Email
**`janaina.araujo@luizabarcelos.com.br`** — e-mail **corporativo**, da página do cliente.
...
### Cadeira / cargo atual
**Processos, Documentação, Estruturação e Mapeamento**

Fonte: página do cliente no Notion, toggle `Pessoas` › `Participantes do Projeto`.
### Nível HIC
⚠ **não se aplica** — é campo da Casa uMode
### Área (organizacional)
**Estratégia, Processos e Projetos** — ⚠ **como a fonte a nomeia**, não necessariamente uma das
