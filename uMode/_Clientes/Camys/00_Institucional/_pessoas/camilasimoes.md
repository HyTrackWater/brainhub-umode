...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Camila Simões`**
### Nome preferido / como é chamado(a)
**Camila Simões**
### Email
**`camilasimoes@camys.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
### Área (organizacional)
**Dono da conta** — **`Perfil de Acesso`** na tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **15/08/2024** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `dono da conta`, da tabela de usuários da página do cliente.
