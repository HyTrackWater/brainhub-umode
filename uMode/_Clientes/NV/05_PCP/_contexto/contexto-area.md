---
aliases:
  - "Planejamento e Controle da Produção · Contexto de área — NV"
tags:
  - tipo/area
  - cliente/nv
  - status/ongoing
...
>
> 🟢 **Esta área é declarada pelo próprio cliente.** O campo *"Departamentos engajados"* do template de transição, na página da NV, lista **`PCP`**.
>
