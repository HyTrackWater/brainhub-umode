---
aliases:
  - "Desenvolvimento de Coleção · Contexto de área — Hering"
tags:
  - tipo/area
  - cliente/hering
...
- pessoas-da-area: ? — [não consta em: página Hering — 🔴 nenhuma fonte de pessoa por área encontrada · 2026-09-23]
- responsavel-area: ? — [não consta em: página Hering — 🔴 nenhuma fonte de pessoa por área encontrada · 2026-09-23]
...
## Produto conectado
`[a preencher]` — **campo vazio na base** · ERP: **`Ilimitar`**
...
| Pessoas e responsáveis de área | Notion — página `Hering` — 🔴 **nenhuma fonte de pessoa por área encontrada** | varrido 23/09/2026 |
...
**Área:** `03_Desenvolvimento-de-Colecao` · **Cliente:** `Hering`
