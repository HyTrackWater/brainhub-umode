...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`janaina`**
### Nome preferido / como é chamado(a)
**janaina**
### Email
**`janaina@osklen.com.br`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
