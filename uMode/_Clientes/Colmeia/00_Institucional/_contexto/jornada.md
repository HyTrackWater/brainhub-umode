...
## Fase atual
No caminho, essa entrega deve ser feita na semana do dia 15/10
...
Fazer apostas baseadas no histórico de Vendas   · Melhorar o NPS das clientes utilizando a Mel
> Campo `Sucesso do Cliente` do CRM — objetivo declarado, não métrica aferida.

## Próximos passos
Finalizar a entrega da uPlan
