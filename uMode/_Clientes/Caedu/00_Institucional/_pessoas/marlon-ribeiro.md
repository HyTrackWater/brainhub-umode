...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`marlon ribeiro`**
### Nome preferido / como é chamado(a)
**marlon ribeiro**
### Email
**`marlon.ribeiro@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **01/12/0202** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu-Geral + TM`, da tabela de usuários da página do cliente. ⚠ **Sem acesso a:** `Meus produtos`.
