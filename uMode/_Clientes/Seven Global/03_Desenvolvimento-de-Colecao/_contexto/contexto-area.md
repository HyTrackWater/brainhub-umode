---
aliases:
  - "Desenvolvimento de Coleção · Contexto de área — Seven Global"
tags:
  - tipo/area
...
- pessoas-da-area: ? — [não consta em: página Seven Global — 🔴 nenhuma fonte de pessoa por área encontrada · 2026-09-23]
- responsavel-area: ? — [não consta em: página Seven Global — 🔴 nenhuma fonte de pessoa por área encontrada · 2026-09-23]
...
## Produto conectado
`Gestão de Coleção` — **1 de 7** · ERP: `[a preencher]`
...
| Pessoas e responsáveis de área | Notion — página `Seven Global` — 🔴 **nenhuma fonte de pessoa por área encontrada** | varrido 23/09/2026 |
...
**Área:** `03_Desenvolvimento-de-Colecao` · **Cliente:** `Seven Global`
