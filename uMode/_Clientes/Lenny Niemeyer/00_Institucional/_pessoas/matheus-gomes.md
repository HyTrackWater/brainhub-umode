# Lenny Niemeyer · Pessoa · matheus gomes
...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`matheus gomes`**
### Nome preferido / como é chamado(a)
**matheus gomes**
### Email
**`matheus.gomes@lennyniemeyer.com`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
