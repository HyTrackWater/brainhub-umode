...
## Status atual
**`Churn`** · `[a preencher]` — **campo vazio na base** · ERP: **`Totvs Moda`**
...
## Observações
- ⚠ **`Totvs Moda` é grafia distinta de `Totvs`** (Recco, Highstil). **Pode ser o mesmo ERP com dois nomes.** **Não unifiquei.**
...
**Registros:** **1 demandas** — [índice](../_demandas/_indice.md) · **1 RFIs** — [índice](../_rfis/_indice.md)
