...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Bruno Soares`**
### Nome preferido / como é chamado(a)
**Bruno Soares**
### Email
**`bruno.soares@osklen.com.br`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
...
|---|---|
| **Demandas abertas** | **1** |
| Primeira atividade observada | 24/09/2025 |
| Última atividade observada | 24/09/2025 |
...
**Observação da fonte:** também Bruno
