...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`thiago lopes`**
### Nome preferido / como é chamado(a)
**thiago lopes**
### Email
**`thiago.lopes@osklen.com.br`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
...
### Área (organizacional)
**Processos e controles internos** — **`Área — auto-declarada na Pesquisa de Satisfação`** na tabela de usuários da plataforma.
