...
>
> **Time declarado:** Operações → Cadastro
>
> **Fonte dupla:** o bloco *Times Envolvidos* das Definições do Projeto **e a agenda do kick-off presencial**, que marcou **uma sessão por área com participantes nomeados**. 🟢 **É a conta com mais pessoas nomeadas da carteira: 14.**
...
🔴 **O escopo declarado do Gerente de Operação do Sul atravessa quatro áreas:** *"**Logística e Cadastro** — **Desenvolvimento até a Precificação** está no guarda-chuva dele"*.

**Isso cobre `07_Logistica-CD`, `08_Ecommerce-Cadastro`, `03_Desenvolvimento-de-Colecao` e `Precificação`** — que **não tem área canônica**.

> **É uma pessoa cobrindo meia cadeia de valor.** Para o modelo de vínculo, **`person_memberships` precisa aceitar múltiplas áreas por pessoa** — e aqui são quatro.
...
## Pessoas desta área
**Marcelo Tonello** — Gerente de Operação do Sul · `marcelo.tonello@luizabarcelos.com.br` · *"Logística e Cadastro"*

**Marcio** — Cadastro · e-mail `[a preencher]`

**Sessão própria no kick-off presencial, 16h–17h**, com Gabriel, Gustavo e Marcelo.

## Produto conectado
`Gestão de Coleção` · `Relatórios` · `Integração` · `Fornecedores` — 4 de 7.
ERP **`Safe Tech`**, com **exclusão contratual explícita de integração com Linx ou qualquer outro**.
...
*Perfil de Usuário e Permissionamentos* · *Regra do Campo Linha* · *Regra Família 05/08/25* ·
*Regras do WorkFlow 12/11* · *Automações da Aba Etapa & Datas 24/09/2025* ·
*Configurações e ajustes pré Go Light* · *Importação das Listas 24/01* ·
*Luiza Barcelos | Integração com ERP* · *Diagnóstico e Reconhecimento* · *TAP (teste) - uFlow* ·
a gravação do kick-off interno · o resumo no **HubSpot** · as bases de Reuniões e Demandas.
...
**Área:** `08_Ecommerce-Cadastro` · **Cliente:** `Luiza Barcelos`
