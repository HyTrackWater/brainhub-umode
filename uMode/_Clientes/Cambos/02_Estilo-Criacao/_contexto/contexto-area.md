---
aliases:
  - "Estilo e Criação · Contexto de área — Cambos"
tags:
  - tipo/area
  - cliente/cambos
  - status/ongoing
...
>
> **Time declarado nas *Definições do Projeto*:** **Desenvolvimento — SP (Brás):** Pesquisa e Criação
>
> **Fonte: acordo com o cliente**, registrado no bloco *Times Envolvidos*, mais a seção *Pessoas* da página. **Sétimo tipo de fonte de vínculo pessoa↔área em oito clientes.**
...
🟢 **Carolina é o único cruzamento limpo de toda a varredura**: nomeada com cargo na página **e** com 6 chamados datados. **Estilista, área de Estilo, uso comprovado.**

**A área recebe demanda do Comercial:** o time Comercial *"passa demandas dos clientes de PL para o time de Estilo e Criação"*. **E essa passagem é uma das cinco dores declaradas** — *"falta de informação, demora no processo de validação"*.

⚠ **O cliente não tem coleção definida.** Faz as 4 estações, *"mas entre elas trabalhamos mais com as demandas do cliente"*. **Estilo aqui responde a pedido de PL, não a calendário de coleção.**
...
## Pessoas desta área
**Carolina** — Estilista · `carolina@cambos.com.br` · **`ATIVO`, 6 chamados em jan/2026**

**Fabiane Sayuri** (*Fabi*) — Responsável pelo Desenvolvimento de Produtos · `fabiane@cambos.com.br` · **co-líder do projeto**

## Produto conectado
`Gestão de Coleção` · `Integração` · `Relatórios` — 3 de 7.
**Quatro sistemas do cliente:** Totvs Virtual Age (comercial, com APIs) · SPI (produção) ·
Banner (pedidos de atacado) · Trello (gestão de processo).
...
*Playbook | Treinamento > IA + Doc Laura* · *Diagnóstico e Reconhecimento* ·
*Cambos | Análise de Demandas* · *Warm Up com Cliente* · *Reunião Kick Off Cliente* ·
*Integração* · **a gravação em vídeo do kick-off interno** · o **Miro** do projeto ·
as bases de Reuniões e Demandas.
...
**Área:** `02_Estilo-Criacao` · **Cliente:** `Cambos`
