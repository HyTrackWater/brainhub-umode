...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`jessica ferreira`**
### Nome preferido / como é chamado(a)
**jessica ferreira**
### Email
**`jessica.ferreira@caedu.com`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **14/11/2023** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Caedu-Estilo`, da tabela de usuários da página do cliente. 🔴 **`Ativo desde` está corrompido na fonte: `14/11/2023`.** Não deduzi a data. ⚠ **Sem acesso a:** `Aba de cadastros`.
