---
aliases:
  - "Lofty Style · Pessoa · marcia santos"
---
# Lofty Style · Pessoa · marcia santos
...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`marcia santos`**
### Nome preferido / como é chamado(a)
**marcia santos**
### Email
**`marcia.santos@loftystyle.com.br`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
