...
> 🔴 **Conta `Inativo` com chamado financeiro em jan/2026.** **Uma conta inativa não deveria ter dúvida de boleto.** `[a preencher]`

| Pessoa | E-mail | Área | Estado | Evidência | Observação |
|---|---|---|---|---|---|
| `[a preencher]` | `contato@palomaconcept.com.br` | `[a preencher]` | `ATIVO_SEM_CADASTRO` | chamado em **08/01/2026** | `FINANCEIRO` — *"dúvida sobre fechamento de boleto"* |
