...
⚠ **Não há área de Design nomeada. O que existe é a `Diretoria Criativa`**, que é o guarda-chuva de oito áreas — não uma área de desenho.

🔴 **A Diretora Criativa nomeia o problema criativo da conta:**
...
**Área:** `12_Design` · **Cliente:** `Luiza Barcelos`
