...
- pessoas-da-area: Uma pessoa só, e ela quer sair da operação — [página Oficina Reserva — 🔴 nenhuma fonte de pessoa por área encontrada · 2026-09-23]
- responsavel-area: ? — [não consta em: página Oficina Reserva — 🔴 nenhuma fonte de pessoa por área encontrada · 2026-09-23]

## O que esta área faz

🔴 **E-commerce e Marketing compartilham UM único perfil: `Oficina - Ecommerce Marketing`.**
...
⚠ **O `institucional.md` já registrava, de fonte fraca, que *"há apenas uma pessoa dedicada ao cadastro"*.** 🟢 **A matriz de perfis é coerente com isso.**
...
## Pessoas desta área
🔴 **Uma pessoa só, e ela quer sair da operação.**

> *"Há apenas uma pessoa dedicada ao cadastro, mas **gostaria de ter um papel mais tático**."*

**A pessoa não tem nome em nenhuma fonte varrida.** Das três que abrem chamado hoje, **nenhuma está identificada por área**.

⚠ **Isso é dor, objetivo de projeto e risco de retenção ao mesmo tempo** — e está sem dono.
...
**Área:** `08_Ecommerce-Cadastro` · **Cliente:** `Oficina Reserva`
