...
>
> 🔴 **Este é o único lugar onde se pergunta "o que ainda não sei sobre o Estrela?" e
...
|--:|---|:-:|---|
| 1 | ⚠ **`Lojas Estrela` na plataforma × `Estrela` no CRM** — não colapsa sozinho, precisa de alias. | `T2` | conferência |
...
### 3.1 · Varridas para a carteira inteira — valem para o Estrela
...
**Cliente:** `Estrela` — [institucional.md](institucional.md) · [jornada.md](jornada.md) · [pessoas.md](pessoas.md)
