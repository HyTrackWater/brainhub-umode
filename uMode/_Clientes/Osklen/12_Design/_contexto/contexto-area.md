...
⚠ **`Design de moda - acessórios/calçados` é subárea por linha de produto**, como `Estilo - Sneakers` e como os quatro perfis de Estilo da VIX.
...
**Mariana Maia** · **Ana Suassuna** · **Taissa** · **Juliana** (`Design de moda`, em três grafias) · **Thays Pantaleão** (`Design de moda - acessórios/calçados`).
