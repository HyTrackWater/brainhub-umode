...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`bianca grassi`**
### Nome preferido / como é chamado(a)
**bianca grassi**
### Email
**`bianca.grassi@camys.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
### Área (organizacional)
**PCP** — **`Perfil de Acesso`** na tabela de usuários da plataforma.
...
| **Ativo na plataforma desde** | **17/05/2022** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** perfil de acesso `Camys - PCP`.
