...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Roselene`**
### Nome preferido / como é chamado(a)
**Roselene**
### Email
**`roselene.fanti@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
|---|---|
| **Demandas abertas** | **3** |
| Primeira atividade observada | 22/10/2025 |
| Última atividade observada | 28/04/2026 |
| Fonte | campo `Quem solicitou?` da base de demandas do Notion |
| **Ativo na plataforma desde** | **28/03/2024** |
| Fonte | tabela de usuários da página do cliente |

**Observação da fonte:** também Rose (3)
