...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`Mylena de Araújo`**
### Nome preferido / como é chamado(a)
**Mylena de Araújo**
### Email
**`mylena.araujo@lennyniemeyer.com`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
...
### Área (organizacional)
**Modelagem lycra** — **`Área — auto-declarada na Pesquisa de Satisfação`** na tabela de usuários da plataforma.
