...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`douglas hungria`**
### Nome preferido / como é chamado(a)
**douglas hungria**
### Email
**`douglas.hungria@lennyniemeyer.com`** — e-mail **corporativo**, da base de **Pesquisa de Satisfação** do cliente — **não é usuário da plataforma**.
