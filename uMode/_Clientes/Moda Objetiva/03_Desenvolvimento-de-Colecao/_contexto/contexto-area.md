---
aliases:
  - "Desenvolvimento de Coleção · Contexto de área — Moda Objetiva"
tags:
  - tipo/area
...
**Tem perfil próprio: `Objetiva - Desenvolvimento de Produto`.**

⚠ **A ficha desta conta tem `Custos` como aba própria** — e ao mesmo tempo `Composição de Custo` está 🔴 para todos. **Duas coisas diferentes com nomes próximos; não as confundi.**
...
## Produto conectado
`Gestão de Coleção` · `Integração` · `Relatórios` · `Cronograma` — **4 de 7** · ERP: **`Ilimitar`**
...
**Área:** `03_Desenvolvimento-de-Colecao` · **Cliente:** `Moda Objetiva`
