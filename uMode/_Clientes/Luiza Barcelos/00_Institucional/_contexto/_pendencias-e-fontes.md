...
|--:|---|:-:|---|
| 1 | 🔺 **Correção registrada: eu disse que a conta era "quase invisível". Errado** — eu media só pela base de chamados, janela de 24 dias. São **24 pessoas, 7 `ATIVO`**. | `T2` | nada — corrigido |
| 2 | ⚠ **ERP `Safe Tech`** — único cliente que o usa. | `T2` | — |
