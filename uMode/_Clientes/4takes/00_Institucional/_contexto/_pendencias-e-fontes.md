...
>
> 🔴 **Este é o único lugar onde se pergunta "o que ainda não sei sobre o 4takes?" e
...
### 3.1 · Varridas para a carteira inteira — valem para o 4takes
...
**Cliente:** `4takes` — [institucional.md](institucional.md) · [jornada.md](jornada.md) · [pessoas.md](pessoas.md)
