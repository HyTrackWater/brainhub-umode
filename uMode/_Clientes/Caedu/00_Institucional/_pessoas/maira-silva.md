...
`[a preencher]`
### Nome completo
`[a preencher]` — a fonte registra **`maira silva`**
### Nome preferido / como é chamado(a)
**maira silva**
### Email
**`maira.silva@caedu.com.br`** — e-mail **corporativo**, da tabela de usuários da plataforma.
...
**Observação da fonte:** perfil de acesso `Gerente de Estilo / Caedu-Estilo`, da tabela de usuários da página do cliente. 🔴 **O campo traz cargo E perfil na mesma célula** (`Gerente de Estilo / Caedu-Estilo`) — a fonte mistura as duas coisas. 🔴 **`Ativo desde` está corrompido na fonte: `17/07/2023`.** Não deduzi a data. ⚠ **Sem acesso a:** `Aba de cadastros`.
